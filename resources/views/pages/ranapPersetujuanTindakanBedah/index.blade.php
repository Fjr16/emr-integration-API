        ...
        <div class="table-responsive text-nowrap">
            <table id="example" class="table">
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a class="btn btn-dark btn-sm"
                                    href="{{ route('persetujuan/tindakan/bedah.detail', $item->rawatInapPatient->id) }}">
                ...
                <div class="dropdown-menu">
                  <a class="dropdown-item" href="{{ route('persetujuan/tindakan/bedah.create', $item->rawatInapPatient->id) }}">
