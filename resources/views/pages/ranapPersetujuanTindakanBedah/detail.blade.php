...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <h4 class="m-0">Persetujuan Tindakan Bedah Pasien {{ $item->queue->patient->name }} <span><a
                        href="{{ route('persetujuan/tindakan/bedah.create', $item->id) }}"
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <form action="{{ route('persetujuan/tindakan/bedah.destroy', $ptb->id) }}"
                                            method="POST">
                                            @csrf
                                            @method('DELETE')
