    ...
    <div class="card p-3 mt-5 ">
        ...
        <div class="d-flex">
            <h4 class="align-self-center m-0">PEMBERIAN INFORMASI DAN
                PERSETUJUAN TINDAKAN BEDAH {{ $item->queue->patient->name }}
            </h4>
            {{-- <div class="ms-auto">
        ...
        <form action="{{ route('persetujuan/tindakan/bedah.store', $item->id) }}" method="POST"
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-8">
                        <input class="form-control form-control-md" type="text"
                            value="{{ $item->suratPengantarRawatJalanPatient->user->name ?? '' }}" disabled />
                        <input type="hidden" value="{{ $item->suratPengantarRawatJalanPatient->user->id ?? '' }}"
                            name="user_id" />
                        </select>
                    </div>
                </div>
                <div class="row mt-2">
                    ...
                    <div class="col-8">
                        <input class="form-control form-control-md" type="text"
                            value="{{ $item->suratPengantarRawatJalanPatient->user->name ?? '' }}" name="petugas"
                            readonly />
                    </div>
                </div>
                <div class="row mt-2">
                ...
                <div>
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-6 d-flex">
                            /
                            <input class="form-check-input col-2 mx-1" type="radio" id="radio_hubungan" value=""
                                onclick="enableHubungan()" />
                            <p class="col d-flex">
                                <input type="text" class="form-control form-control-sm" id="input_hubungan" disabled
                                    name="hubungan" onchange="transferValueHubungan(this.value)">
                            </p>
                        </div>
                    </div>
                    <div class="row">
