...
@section('content')
    ...
    <div class="card p-3 mt-5 ">
        <div class="d-flex">
            <h4 class="align-self-center m-0">RENCANA PULANG (<em>DISCHARGE PLANNING</em>)
        ...
        <form action="{{ route('checklist/rencana/pulang/page/two.store', $item->id) }}" method="POST"
            ...
            <div class="card-body">
                    ...
                    <tbody>
                        <tr>
                            <td class="text-center">
                                <select name="medicine_id[]" id="medicine_id_1" class="form-control form-control-sm">
                                    @foreach ($medicines as $medicine)
                                        <option value="{{ $medicine->id }}">{{ $medicine->kode }} - {{ $medicine->name }}
                                        </option>
                                    @endforeach
                                </select>
                            </td>
                            ...
                            <td><input type="datetime-local" class="form-control form-control-sm" name="waktu_pemberian[]"
                                    value="{{ date('Y-m-d H:i:s') }}" required></td>
                            <td><input type="text" class="form-control form-control-sm" name="cara_pemberian[]" required>
                            </td>
                            <td class="text-center">
                ...
                <div class="row mb-5">
                    ...
                    <div class="col-4 text-center">
                        ...
                        <textarea id="ttdDietisien" name="ttd_petugas_gizi" style="display: none;"></textarea>
                        <button type="button" class="col-12 btn btn-sm btn-dark"
                            onclick="openModal(this, 'ImgTtdDietisien', 'ttdDietisien', 'nm_petugas_gizi')">Tanda
                            Tangan</button>
                    </div>
                    <div class="col-4 text-center">
                        <img src="" alt="" id="ImgTtdFarmasi">
                        <textarea id="ttdFarmasi" name="ttd_petugas_farmasi" style="display: none;"></textarea>
                        <button type="button" class="col-12 btn btn-sm btn-dark"
                ...
                <div class="row">
                    ...
                    <div class="col-4 text-center">
                        <input type="text" class="form-control" name="nm_petugas_gizi" id="nm_petugas_gizi"
                            placeholder="Nama Dietisien" @readonly(true)>
                    </div>
                    <div class="col-4 text-center d-flex">
                        <input type="text" class="form-control" name="nm_petugas_farmasi" id="nm_petugas_farmasi"
                            placeholder="Nama Farmasi Klinis" @readonly(true)>
                    </div>
                </div>
