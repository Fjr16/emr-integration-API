...
<form action="{{ route('kemoterapi/cppt.store', $item->id) }}" method="POST" onsubmit="return confirm('Apakah Anda Yakin Ingin Melanjutkan ?')">
  @csrf
  <div class="card">
    <div class="card-header d-flex align-items-center justify-content-between">
      <div class="col-11 d-flex">
        <h5 class="mb-0">Tambah CPPT Kemoterapi</h5>
      </div>
