            ...
            <table class="table-bordered w-100 mt-4">
                <thead>
                    <tr class="text-center text-sm">
                        ...
                        <th class="m-0">Profesiona Pember Asuhan (PPA)</th>
                        <th class="m-0">
                ...
                <tbody>
                    @foreach ($item->cpptRanaps as $cppt)
                        @php
                        ...
                        <tr class="small">
                                                ...
                                                <td>
                                                    @if ($cppt->ttd_dpjp)
                                                        ...
                                                        <span>Dikonfirmasi oleh pemberi intruksi <br>
                                                            <span
                                                                class="fw-bold">{{ $tanggalValidasiDpjp->format('d M Y') }}</span><br>
                                                ...
                                                <td>
                                                    @if ($cppt->ranapCpptAlihRawatPatient)
                                                        @if ($cppt->ranapCpptAlihRawatPatient->ttd_user)
                                                            ...
                                                            @else
                                                                <span class="fw-bold border">MENUNGGU KONFIRMASI DOKTER
                                                                    TUJUAN</span>
                                                        @endif
                                                    @else
                            ...
                            <td class="text-center">
                                @if ($cppt->ranapCpptSbarPatient)
                                    <img src="{{ Storage::url($cppt->ranapCpptSbarPatient->ttd ?? '') }}"
                                        alt="" class="img-thumbnail">
