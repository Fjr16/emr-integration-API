...
<form action="{{ route('ranap/cppt.update', $item->id) }}" method="POST" onsubmit="return confirm('Apakah Anda Yakin Ingin Melanjutkan ?')">
  @csrf
  @method('PUT')
  <div class="card">
    <div class="card-header d-flex align-items-center justify-content-between">
      <div class="col-11 d-flex">
        <h5 class="mb-0">Edit CPPT</h5>
      </div>
    ...
    <div class="card-body">
      ...
      <div class="mb-3" id="formParafUser">
        ...
        <div class="row mb-3">
          <div class="col-3">
            <img src="{{ Storage::url($item->ttd_user ?? '') }}" alt=""  id="imgTtdUser" class="border">
          </div>
        </div>
      </div>
