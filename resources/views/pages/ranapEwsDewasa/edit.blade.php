    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-6">
                    <form method="POST" action="{{ route('ews/dewasa.update', $item->id) }}">
                        @method('PUT')
                        @csrf
                        <div class="row">
                            <div class="col-6">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="date" name="tanggal" class="form-control" id="basic-default-name" value="{{ $item->tanggal ?? '' }}"
                                    @required(true)>
                            </div>
                        </div>
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="time" name="jam" class="form-control" id="basic-default-name" value="{{ $jam->format('H:i') ?? '' }}"
                                    @required(true)>
                            </div>
                        </div>
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="number" name="frekuensi_napas" class="form-control" id="basic-default-name" onchange="hitungSkor()" value="{{ $item->frekuensi_napas ?? '' }}"
                                    @required(true)>
                            </div>
                        </div>
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="number" name="frekuensi_nadi" class="form-control" id="basic-default-name" onchange="hitungSkor()" value="{{ $item->frekuensi_nadi ?? '' }}"
                                    @required(true)>
                            </div>
                        </div>
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="number" name="tekanan_sistolik" class="form-control" id="basic-default-name" onchange="hitungSkor()" value="{{ $item->tekanan_sistolik ?? '' }}"
                                    @required(true)>
                            </div>
                        </div>
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="number" name="suhu" step="any" class="form-control" id="basic-default-name" onchange="hitungSkor()" value="{{ $item->suhu ?? '' }}"
                                    @required(true)>
                            </div>
                        </div>
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="number" name="total_skor" class="form-control" id="jumlah_skor" value="{{ $item->total_skor ?? '' }}"
                                    readonly>
                            </div>
                        </div>
                        <div class="text-end">
