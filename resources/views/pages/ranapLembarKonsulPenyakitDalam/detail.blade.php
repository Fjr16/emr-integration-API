...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <h4 class="m-0">Konsultasi Penyakit Dalam Pasien {{ $item->queue->patient->name }} <span><a
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('jawaban/konsultasi/penyakit/dalam.create', $k->ranapJawabanKonsulPenyakitDalamPatient->id) }}"
                                    target="blank" class="btn btn-dark btn-sm mx-2"><i class='bx bx-plus'></i></a>
                            </td>
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <form action="{{ route('lembar/konsultasi/penyakit/dalam.destroy', $k->id) }}"
                                            method="POST">
                                            @csrf
                                            @method('DELETE')
