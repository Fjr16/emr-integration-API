...
@section('content')
    <div class="card mb-4">
        <div class="card-header d-flex align-items-center justify-content-between">
            <h5 class="mb-0">General Consent Patient {{ $item->queue->patient->name }}</h5>
        </div>
        <div class="card-body">
            <form method="POST" action="{{ route('general-consent-ranap.store', $item->id) }}">
                @csrf
                <div class="row">
                    <div class="col-md-6">
                        <div class="row mb-3">
                ...
                <div class="">
                    ...
                    <p class="">
                      Saya menyetujul untuk perawatan di RSK Bedah Ropanasuri sebagai pasien rawat inap tergantung kepada rencana asuhan sesuai dengan kebutuhan pasien dengan Dokter Penanggung Jawab Pelayanan (DPJP) adalah {{ $dpjp->user->name ?? '' }} ({{ $dpjp->user->staff_id ?? '' }})
                    </p>
                    <p>
