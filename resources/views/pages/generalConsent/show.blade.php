        ...
        <div class="header">
            <div class="row">
                ...
                <div class="col-8 d-flex align-self-center">
                    <h1 class="mx-auto text-uppercase text-center">
                        persetujuan umum <br />(General consent)
                    </h1>
                </div>
                <div class="col-2">
                    <!-- <div
        ...
        <div class="content">
            <table class="table-bordered w-100 mt-2">
                <tbody>
                    ...
                    <tr>
                        <td>
                            <p class="m-0 fw-bold" style="font-size: 8pt">
                            ...
                            <div style="margin: -2mm 4mm">
                                ...
                                <!--  -->
                                <div class="d-flex" style="margin-top: -3mm">
                        ...
                        <td>
                            <ol class="m-0">
                                <li>
                                    ...
                                    sesuai dengan kebutuhan pasien dengan
                        ...
                        <td>
                            <ol>
                                <li>
                                    ...
                                    RSK Bedah Ropanasuri memberikan akses
                                    bagi keluarga serta orang yang akan
                                    membesuk / menemui saya.
                                </li>
                                <li>
                                ...
                                <li class="mb-3">
                                    Saya {{ $item->kebutuhan_privasi3 ?? '.........' }}
                                    privasi khusus (sebutkan bila ada
                                    privasi khusus) :
                                </li>
                                <p style="margin-top: -4mm">
                    ...
                    <tr>
                        <td>
                            <ol>
                                ...
                                <li class="mb-3">
                                    Saya {{ $item->persetujuan_pelepasan_informasi == 'ya' ? 'menyetujui' : 'tidak menyetujui' }}
                                ...
                                <p style="margin-top: -4mm">
                                    nama : {{ $item->name ?? '.....................' }}, hubungan dengan pasien : {{ $item->hubungan ?? '......................................' }}
                                </p>
                            </ol>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td>
                            <p>
                                Saya telah menerima informasi tentang tata
                                tertib yang diberlakukan oleh RSK Bedah
                                Ropanasuri dan saya beserta keluarga
                                bersedia untuk mematuhinya, termasuk akan
                                mematuhi jam berkunjung pasien sesuai dengan
                    ...
                    <tr>
                        <td>
                            <ol>
                                <li>
                                    Sebagai peserta JKN dan atau Asuransi
                                    lainnya Saya bersedia mengurus jaminan
                                    Rawat Inap dalam waktu 3 x 24 jam hari
                                    kerja (terhitung pasien masuk) dan atau
                                    sebelum pasien pulang. Apabila saya
                                    tidak mengurus dalam waktu tersebut
                                    diatas, saya bersedia terdaftar sebagai
                                    pasien umum / pribadi. Saya memahami
                                    tentang informasi biaya pengobatan atau
                                    biaya tindakan yang dijelaskan oleh
                                    petugas Rumah Sakit.
                                </li>
                                <li>
                                    Pasien umum / pribadi pembiayaan yang
                                    dikenakan mengacu kepada tarif pelayanan
                                    yang ada di RSK Bedah Ropanasuri Padang.
                                </li>
                            </ol>
                        </td>
                    </tr>
                        ...
                        <td>
                            ...
                            <div class="row">
                                ...
                                <div class="col-5">
                                    ...
                                    {{-- <br /><br /><br /> --}}
                                    <img src="{{ Storage::url($item->ttd) }}" alt="" height="70px">
