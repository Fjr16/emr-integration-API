        ...
        <div class="card-body">
            <div class="nav-align-top mb-4 shadow-sm">
                <ul class="nav nav-tabs nav-sm nav-fill" role="tablist">
                    ...
                    <li class="nav-item">
                        <button id="btn-link" type="button"
                            class="nav-link {{ session('active') == 'asesmen_awal_keperawatan' ? 'active' : '' }} d-flex justify-content-center"
                            role="tab" data-bs-toggle="tab" data-bs-target="#navs-justified-assesmen-awal-keperawatan"
                            aria-controls="navs-justified-asesmen-awal-keperawatan" aria-selected="false">
                            <i class="tf-icons bx bx-bookmark-alt-plus"></i>
                            <p class="m-0">Asesmen Awal Keperawatan</p>
                        </button>
                    </li>
                    </li>
                    <li class="nav-item">
                ...
                <div class="tab-content">
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu">
                                                    ...
                                                    <form
                                                        action="{{ route('kemoterapi/general/consent.destroy', $gc->id) }}"
                                                        method="POST">
                                                        @method('DELETE')
                                                        @csrf
                                ...
                                @foreach ($item->queue->patient->kemoterapiInitialAssesments->where('isActive', true) as $itemAssesment)
                                    <tr>
                                        ...
                                        <td class="d-flex">
                                            ...
                                            <form
                                                action="{{ route('kemoterapi/assesmenawal.destroy', $itemAssesment->id) }}"
                                                method="POST">
                                                @csrf
                                                @method('DELETE')
                    ...
                    <div class="tab-pane fade {{ session('active') == 'assesmen_awal_keperawatan' ? 'show active' : '' }}"
                    id="navs-justified-assesmen-awal-keperawatan" role="tabpanel">


                    <div class="text-end">
                        <a href="{{ route('kemoterapi/asesmen/status/fisik.index', $item->id) }}"
                            class="btn btn-success btn-sm">+Tambah
                            Assesmen</a>
                    </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item"
                                                    href="{{ route('ranap/assesmen/awal/keperawatan.show', $d->id) }}"
                                                    target="_blank">
                                                    <i class="bx bx-printer me-1"></i>
                                                    Print
                                                </a>
                                                <a class="dropdown-item"
                                                    href="{{ route('ranap/assesmen/awal/keperawatan.edit', $d->id) }}">
                                                    <i class="bx bx-edit-alt me-1"></i>
                                                    Edit
                                                </a>
                                                <form
                                                    action="{{ route('ranap/assesmen/awal/keperawatan.destroy', $d->id) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit" class="dropdown-item"
                ...
                {{-- end Assesmen awal Keperawatan --}}
                            ...
                            <tbody>
                                @foreach ($cpptKemoterapi as $cppt)
                                    <tr>
                                        ...
                                        {{-- @canany(['catatan pelayanan pt form kemoterapi edit', 'catatan pelayanan pt form kemoterapi delete']) --}}
                                        <td class="d-flex">
                                            {{-- @can('catatan pelayanan pt form kemoterapi edit') --}}
                                            <a href="{{ route('kemoterapi/cppt.edit', $cppt->id) }}"
                                                class="btn btn-warning btn-sm"><i class='bx bx-edit'></i></a>
                                            {{-- @endcan --}}
                                            {{-- @can('catatan pelayanan pt form kemoterapi delete') --}}
                                            <form action="{{ route('kemoterapi/cppt.destroy', $cppt->id) }}"
                                                method="POST">
                                                @csrf
                                                @method('DELETE')
                    ...
                    <div class="tab-pane fade {{ session('btn') == 'discharge' ? 'show active' : '' }}"
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="text-end mb-3">
                                    {{-- @can('print discharge') --}}
                                    <a href="{{ route('ringkasan/catatan/medis/kemoterapi.show', $item->id) }}"
                    ...
                    <div class="tab-pane fade {{ session('btn') == 'sbpk' ? 'show active' : '' }}"
                        ...
                        <div class="text-end mb-3">
                            <a href="{{ route('kemoterapi/sbpk.create', $item->id) }}"
                                class="btn btn-success btn-sm">+Tambah
                                SBPK</a>
                        </div>
                        <table class="table">
