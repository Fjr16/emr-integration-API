...
<form action="{{ route('rajal/cppt.store', $item->id) }}" method="POST" onsubmit="return confirm('Apakah Anda Yakin Ingin Melanjutkan ?')">
    @csrf
    <div class="card">
        <div class="card-header d-flex align-items-center justify-content-between">
          <div class="col-11 d-flex">
            ...
            @role('Dokter Poli')
              <a href="{{ route('rajal/permintaan/radiologi.create', $item->id) }}" class="btn btn-success btn-sm mx-2">+ Permintaan Radiologi</a>
              <a href="{{ route('permintaan/laboratorium/patologi/anatomik.create', $item->id) }}" class="btn btn-success btn-sm">+ Permintaan Labor PA</a>
              <a href="{{ route('rajal/laboratorium/request.index', $item->id) }}" class="btn btn-success btn-sm mx-2">+ Permintaan Labor PK</a>
            @endrole
          </div>
