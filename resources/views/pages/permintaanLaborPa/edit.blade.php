...
@section('content')
    ...
    <div class="card mb-4">
        <div class="card-header d-flex align-items-center justify-content-between">
            <h5 class="mb-0">Edit Permintaan Laboratorium Patologi Anatomik</h5>
            <button type="button" class="btn btn-sm btn-success" onclick="history.back()">Kembali</button>
        </div>
        <form id="upload-form" action="{{ route('permintaan/laboratorium/patologi/anatomik.update', $item->id) }}"
            ...
            <div class="card-body">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-9">
                        <input name="no_sediaan" class="form-control" type="text" value="{{ $item->no_sediaan }}"
                            required />
                    </div>
                </div>
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-9">
                        <select class="form-select" id="exampleFormControlSelect1" aria-label="Default select example"
                            ...
                            <option value="Biopsi" {{ $item->jaringanTubuhDiDapat == 'Biopsi' ? 'selected' : '' }}>Biopsi
                            </option>
                            <option value="Operasi" {{ $item->jaringanTubuhDiDapat == 'Operasi' ? 'selected' : '' }}>
                                Operasi</option>
                            <option value="Kerokan" {{ $item->jaringanTubuhDiDapat == 'Kerokan' ? 'selected' : '' }}>
                                Kerokan</option>
                        </select>
                ...
                <div class="row mb-3">
                    <label for="lokasi_jaringan_yang_diambil" class="col-form-label col-2">Lokasi jaringan yang
                        diambil</label>
                    <div class="col-9">
                        <textarea class="form-control" type="text" name="lokasiJaringanYangDiAmbil" required>{{ $item->lokasiJaringanYangDiAmbil }} </textarea>
                    </div>
                </div>
                <div class="row mb-3">
                    <label for="pengobatan_yang_telah_diberikan" class="col-form-label col-2">Pengobatan yang telah
                        diberikan</label>
                    <div class="col-9">
                        <textarea class="form-control" type="text" name="pengobatanYangTelahDiBerikan" required>{{ $item->pengobatanYangTelahDiBerikan }}</textarea>
                    </div>
                </div>
                <div class="row mb-3">
                    <label for="diagnosis_klinik" class="col-form-label col-2">Diagnosis Klinik</label>
                    <div class="col-9">
                        <textarea class="form-control" type="text" name="diagnosisKlinik" required>{{ $item->diagnosisKlinik }}</textarea>
                    </div>
                </div>
                <div class="row mb-3">
                    <label for="keterangan_klinik" class="col-form-label col-2">Keterangan Klinik</label>
                    <div class="col-9">
                        <textarea class="form-control" type="text" name="keteranganKlinik" required>{{ $item->keteranganKlinik }}</textarea>
                    </div>
                </div>
                <div class="row mb-3">
                    ...
                    <div class="col-9">
                        <div class="row">
                                ...
                                @foreach (['faces' => 'wajah.png', 'neck' => 'leher.png', 'breast' => 'payudara.png'] as $id => $img)
                                    <div class="col-12 col-lg-4 mb-3 mb-lg-0">
                                        <div class="d-flex flex-column">
                                            ...
                                            <button type="button" id="clear{{ ucfirst($id) }}"
                            ...
                            <div class="row mb-4">
                                <div class="col-12 text-center">
                                    <span class="col-form-label">Sketsa Lokasi Sebelumnya</span>
                                </div>
                                @foreach (['faces' => 'gambarLokasiMuka', 'neck' => 'gambarLokasiLeher', 'breast' => 'gambarLokasiDada'] as $id => $lokasi)
                                    <div class="col-12 col-lg-4 mb-3 mb-lg-0">
                                        <div class="d-flex flex-column">
                                            <div id="{{ $id }}" class="text-center">
                                                <img id="{{ $id }}" src="{{ Storage::url($item->$lokasi) }}"
                                                    alt="" class="img-fluid" style="height: 250px">
                                            </div>
                                        </div>
                                    </div>
                                @endforeach
                        ...
                        <textarea class="form-control" type="text" name="sketsaLokasi" required>{{ $item->sketsaLokasi }}</textarea>
                    </div>
                </div>
                <div class="row mb-3">
                ...
                <div class="row mb-5">
                    ...
                    <div class="col-9">
                        <input class="form-control" type="date" name="hphjt" value="{{ $item->hphjt }}" />
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-11">
                        <textarea class="form-control" type="text" name="catatan">{{ $item->catatan }}</textarea>
                    </div>
                </div>
