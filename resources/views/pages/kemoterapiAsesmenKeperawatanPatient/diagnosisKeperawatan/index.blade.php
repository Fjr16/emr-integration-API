        ...
        <div class="row mb-3">
          ...
          <div class="col-sm-7">
            ...
            <div class="form-check">
              <input class="form-check-input" type="checkbox" value="{{$bd}}" name="ansietas[]" id="defaultCheck2" />
          ...
          <div class="col-sm-7">
            ...
            <div class="form-check">
              <input class="form-check-input" type="checkbox" value="{{$bd}}" name="nyeri-akut[]" id="defaultCheck2" />
              <label class="form-check-label" for="defaultCheck2">
                {{ $bd }}
              </label>
            </div>
          ...
          <div class="col-sm-7">
            ...
            <div class="form-check">
              <input class="form-check-input" type="checkbox" value="{{$bd}}" name="nyeri-kronis[]" id="defaultCheck2" />
              <label class="form-check-label" for="defaultCheck2">
                {{ $bd }}
              </label>
            </div>
          ...
          <div class="col-sm-7">
            ...
            <div class="form-check">
              <input class="form-check-input" type="checkbox" value="{{$bd}}" name="gangguan-mobilitas-fisik[]" id="defaultCheck2" />
              <label class="form-check-label" for="defaultCheck2">
                {{ $bd }}
              </label>
            </div>
          ...
          <div class="col-sm-3 form-check mx-4">
            <input class="form-check-input" type="checkbox" value="Nausea" name="diagnosis-keperawatan[]" id="defaultCheck1" />
            <label class="form-check-label" for="defaultCheck1">
              Nausea
            </label>
          </div>
          ...
          <div class="col-sm-7">
            ...
            <div class="form-check">
              <input class="form-check-input" type="checkbox" value="{{$bd}}" name="nausea[]" id="defaultCheck2" />
              <label class="form-check-label" for="defaultCheck2">
               {{$bd}}
              </label>
            </div>
          ...
          <div class="col-sm-3 form-check mx-4">
            <input class="form-check-input" type="checkbox" value="Risiko Pendarahan" name="diagnosis-keperawatan[]" id="defaultCheck1" />
            <label class="form-check-label" for="defaultCheck1">
              Risiko Pendarahan
            </label>
          </div>
          ...
          <div class="col-sm-7">
            ...
            <div class="form-check">
              <input class="form-check-input" type="checkbox" value="{{$bd}}" name="risiko-pendarahan[]" id="defaultCheck2" />
              <label class="form-check-label" for="defaultCheck2">
                {{ $bd }}
              </label>
            </div>
          ...
          <div class="col-sm-3 form-check">
            <div class="d-flex align-items-center">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control form-control-sm" id="lainnya" name="diagnosis-lainnya" placeholder="" aria-describedby="floatingInputHelp" />
              </div>
            </div>
          </div>
        ...
        <div class="row mb-3">
          <div class="col-sm-4 ">
            <div class="mx-2">
              ...
              <div class="form-check">
                <input class="form-check-input" type="checkbox" value="{{$keperawatan}}" name="masalah-keperawatan[]" id="defaultCheck1" />
                <label class="form-check-label" for="defaultCheck1">
                  {{ $keperawatan }}
                </label>
              </div>
