...
@if (session()->has('success'))
  ...
  <div class="card mb-4">
    ...
    <div class="card-body">
        ...
        <form action="{{ route('ranap/asesmen/skrining/resiko/jatuh.store', $item->id) }}" method="POST">
          @csrf
                ...
                <div class="row">
                  ...
                  <div class="col-sm-1">
                    <div class="form-check form-check-inline">
                      <input class="form-check-input" name="kategori" type="radio" id="inlineCheckbox1" value="Rendah" checked />
                      <label class="form-check-label" for="inlineCheckbox1">Rendah</label>
                    </div>
                  </div>
                  <div class="col-sm-1">
                    <div class="form-check form-check-inline">
                      <input class="form-check-input" name="kategori" type="radio" id="inlineCheckbox2" value="Sedang" />
                      <label class="form-check-label" for="inlineCheckbox2">Sedang</label>
                    </div>
                  </div>
                  <div class="col-sm-1">
                    <div class="form-check form-check-inline">
                      <input class="form-check-input" name="kategori" type="radio" id="inlineCheckbox2" value="Tinggi" />
                      <label class="form-check-label" for="inlineCheckbox2">Tinggi</label>
                    </div>
                  </div>
                  <div class="col-sm-4">
                    <div class="form-check form-check-inline">
                      <input class="form-check-input" name="kategori" type="radio" id="inlineCheckbox2" value="Pasang Kancing Kuning (jika risiko tinggi)" />
          ...
          <table class="table table-bordered mb-3" >
              ...
              <tr>
                <td>
                    <div class="row">
                        ...
                        <div class="col-sm-1">
                            <div class="form-check form-check-inline">
                            <input class="form-check-input" name="diagnosa" type="radio" id="inlineCheckbox5" value="Tidak" checked />
                            <label class="form-check-label" for="inlineCheckbox5">Tidak</label>
                            </div>
                        </div>
                        <div class="col-sm-1">
                            <div class="form-check form-check-inline">
                            <input class="form-check-input" name="diagnosa" type="radio" id="inlineCheckbox6" value="Ya" />
            ...
            <div class="mb-2">
                <div class="form-check form-check-inline">
                    <input class="form-check-input" name="status" type="radio" id="inlineCheckbox7" value="Ya" onclick="enableTanggal()" checked />
                    <label class="form-check-label" for="inlineCheckbox7">Ya, tanggal <input type="date" name="date" id="date" class="form-control form-control-sm"> dan jam <input type="time" name="time" id="time" class="form-control form-control-sm"></label>

                </div>
                <br>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" name="status" type="radio" id="inlineCheckbox8" value="Tidak" onclick="disableTanggal()" />
                ...
                <div class="row mb-5">
                    ...
                    <div class="col-4 text-center"></div>
                    <div class="col-4 text-center">
                        <input type="text" class="form-control form-control-sm" name="dietisien"
