...
<div class="card mb-4">
  <form method="POST" action="{{ route('user.store') }}">
    ...
    <div class="card-body">
      ...
      <div class="row mb-4">
        ...
        <div class="col-sm-3">
          ...
          <input type="date" name="tgl_lahir" class="form-control" id="basic-default-name" value="{{ old('tgl_lahir') }}" @required(true)/>
        </div>
        <div class="col-sm-3">
        ...
        <div class="col-sm-3">
          ...
          <input type="number" name="jumlah_anak" class="form-control" id="basic-default-name" value="{{ old('jumlah_anak', 0) }}" @required(true)/>
        </div>
      </div>
      <div class="row mb-4">
        <div class="col-sm-4">
      ...
      <div class="row mb-4">
        ...
        <div class="col-sm-4">
          <label class="form-label" for="basic-default-name">Pengalaman Kerja</label>
            <textarea name="pengalaman" class="form-control" placeholder="Tuliskan Pengalaman kerja anda disini jika ada" rows="5">{{ old('pengalaman') }}</textarea>
        </div>
      </div>
      <hr>
      {{--  --}}
        ...
        <div class="col-sm-6">
          ...
          <div class="row mb-3">
            <div class="col-sm-6">
              ...
              <input type="text" name="ayah" class="form-control" id="basic-default-name" placeholder="Nama Ayah" value="{{ old('ayah') }}"/>
            </div>
            <div class="col-sm-6">
              <label class="form-label" for="basic-default-name">Nama Ibu</label>
              <input type="text" name="ibu" class="form-control" id="basic-default-name" placeholder="Nama Ibu" value="{{ old('ibu') }}"/>
            </div>
          </div>
          <div class="row mb-3">
            <div class="col-sm-6">
              <label class="form-label" for="basic-default-name">Nama Kontak Darurat</label>
              <input type="text" name="nama_kontak_darurat" class="form-control" id="basic-default-name" placeholder="Nama Kontak Darurat" value="{{ old('kontak_darurat') }}"/>
            </div>
            <div class="col-sm-6">
        ...
        <div class="col-sm-6">
          ...
          <div class="row mb-3">
            <div class="col-4">
              ...
              <input type="date" name="tgl_masuk" class="form-control" id="basic-default-name" value="{{ old('tgl_masuk') }}"/>
            </div>
            <div class="col-sm-8">
          ...
          <div class="row">
              ...
              <div class="col-sm-8">
                ...
                <textarea name="tanda_tangan" id="ttdTextArea" cols="30" rows="10" style="display: none"></textarea>
              </div>
          </div>
        </div>
      </div>
    ...
    <div class="text-end mt-5">
      <button type="submit" class="btn btn btn-outline-primary" onclick="return confirm('Yakin ingin melanjutkan ?')">Submit</button>
    </div>
  </div>
  </form>
</div>
