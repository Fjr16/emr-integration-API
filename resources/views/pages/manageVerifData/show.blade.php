        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-10 col-12 border">
                    <div class="row">
                        <button class="btn btn-dark btn-md" style="border-radius: 0%"><i class="bx bx-check"></i> Verifikasi</button>
                    </div>
                            ...
                            <div class="accordion accordion-header-primary" id="accordionStyle{{ $loop->iteration ?? '' }}">
                                <div class="accordion-item card border">
                                    <h2 class="accordion-header">
                                        <button type="button" class="accordion-button collapsed text-uppercase" data-bs-toggle="collapse" data-bs-target="#accordionStyle-1" aria-expanded="false">
                                        {{ $item->dpjp->poliklinik->name ?? '' }} - {{ $item->dpjp->name ?? '' }}
                                        </button>
                                    </h2>
                                
                                    <div id="accordionStyle-1" class="accordion-collapse collapse" data-bs-parent="#accordionStyle1">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if ($item->soapDokter->ttd || $item->ttd_verif)
                                                    <img src="{{ $item ? (asset('storage/' . $item->soapDokter->ttd ?? $item->ttd_verif)) : '' }}" width="150" alt="">
                                                    {{ $item->dpjp->name ?? '' }}
                                                @endif
                                            </td>
                                        </tr>
