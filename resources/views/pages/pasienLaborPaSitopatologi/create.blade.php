...
@section('content')
    ...
    <div class="card mb-4">
        <div class="card-header d-flex align-items-center justify-content-between">
            <h5 class="mb-0">Input Bacaan Sitopatologi</h5>
            <button type="button" class="btn btn-sm btn-success" onclick="history.back()" >Kembali</button>
        </div>
        <form action="{{ route('permintaan/laboratorium/patologi/anatomik.storeHasilSitopatologi', $item->id) }}" method="POST" onsubmit="return confirm('Apakah Anda Yakin Ingin Melanjutkan ?')">
            @csrf
            <div class="card-body">
                <div class="row mb-3">
                    <label for="no_pendaftaran" class="col-form-label col-2">No. Pendaftaran</label>
                    <div class="col-10">
                        <input class="form-control" name="no_pend" type="text" value="{{ $noSito ?? '' }}" readonly/>
                    </div>
                </div>
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                    <label for="bacaan" class="col-form-label col-2">Bacaan</label>
                    <div class="col-10">
                        <textarea class="form-control" type="text" id="editor" name="bacaan" value=""> </textarea>
                    </div>
                </div>
                <div class="row mb-3">
                    <label for="diagnosa" class="col-form-label col-2">Diagnosa</label>
                    <div class="col-10">
                        <textarea class="form-control" type="text" id="editor1" name="diagnosis" value=""> </textarea>
                    </div>
                </div>
                <div class="row mb-3">
                    <label for="diagnosa" class="col-form-label col-2">Kesan</label>
                    <div class="col-10">
                        <textarea class="form-control" type="text" id="editor2" name="kesan" value=""> </textarea>
                    </div>
                </div>
                <div class="row mb-3">
