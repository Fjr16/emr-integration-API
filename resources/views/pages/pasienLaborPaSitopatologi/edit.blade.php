...
@section('content')
    ...
    <div class="card mb-4">
        ...
        <form action="{{ route('permintaan/laboratorium/patologi/anatomik.updateHasilSitopatologi', $hasil->id) }}" method="POST" onsubmit="return confirm('Apakah Anda Yakin Ingin Melanjutkan ?')">
            @csrf
            @method('PUT')
            <div class="card-body">
                <div class="row mb-3">
                    ...
                    <div class="col-10">
                        <input class="form-control" type="text" value="{{ $hasil->no_pend }}" placeholder="13131231/27-sep-2023/ropanasuri"/>
                    </div>
                </div>
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-10">
                        <textarea class="form-control" type="text" id="editor" name="bacaan" value="">{!! $hasil->bacaan !!}</textarea>
                    </div>
                </div>
                <div class="row mb-3">
                    <label for="diagnosa" class="col-form-label col-2">Diagnosa</label>
                    <div class="col-10">
                        <textarea class="form-control" type="text" id="editor1" name="diagnosis" value="">{!! $hasil->diagnosis !!}</textarea>
                    </div>
                </div>
                <div class="row mb-3">
