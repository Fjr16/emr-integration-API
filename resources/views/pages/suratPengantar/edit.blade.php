...
@section('content')
    <div class="card mb-4">
        <div class="card-header d-flex align-items-center justify-content-between">
            <h5 class="mb-0">Edit Surat Pengantar Rawat</h5>
        </div>
        <div class="card-body">
            <form method="POST" action="{{ route('suratpengantar.update', $data->id) }}">
                @csrf
                @method('PUT')
                <div class="row mb-3">
                    <label class="col-sm-2 col-form-label" for="basic-default-name">Diagnosa Primer</label>
                    <div class="col-sm-10">
                        <input type="text" name="diagnosa_primer" class="form-control" id="basic-default-name" value="{{ $data->primer }}">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        @foreach ($data->operasiSuratPengantarRawatJalanPatient as $operasi)    
                    ...
                    <div class="col-sm-10">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="prioritas_kebutuhan[]"
                                value="Preventif" {{ in_array('Preventif', $data5) ? 'checked' : '' }}> Preventif
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="prioritas_kebutuhan[]"
                                value="Paliatif" {{ in_array('Paliatif', $data5) ? 'checked' : '' }}> Paliatif
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="prioritas_kebutuhan[]"
                                value="Ruangan Biasa" {{ in_array('Ruangan Biasa', $data5) ? 'checked' : '' }}> Ruangan
                            Biasa
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="prioritas_kebutuhan[]" value="Kuratif"
                                {{ in_array('Kuratif', $data5) ? 'checked' : '' }}> Kuratif
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="prioritas_kebutuhan[]"
                    ...
                    <div class="col-sm-10">
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="ruangan" value="Ruangan Biasa"
                                {{ $data->ruangan == 'Ruangan Biasa' ? 'checked' : '' }}>
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="ruangan" value="Ruangan Isolasi"
                                {{ $data->ruangan == 'Ruangan Isolasi' ? 'checked' : '' }}>
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="ruangan" value="HCU"
                                {{ $data->ruangan == 'HCU' ? 'checked' : '' }}>
                            <label class="form-check-label" for="basic-default-name">HCU</label>
                        </div>
