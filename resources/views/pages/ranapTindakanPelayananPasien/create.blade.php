...
@section('content')
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('rekapitulasi/tindakan/pelayanan/pasien.store', $item->id) }}">
                @csrf
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <select class="form-control select2" name="action_members_id" onchange="getBiayaTindakan(this.value, {{ $item->rawatInapPatient->queue->patientCategory->id }})">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <select class="form-control select2" name="user_id" onchange="getBiayaKonsul(this.value, {{ $item->rawatInapPatient->queue->patientCategory->id }})">
                            <option selected disabled>Pilih</option>
