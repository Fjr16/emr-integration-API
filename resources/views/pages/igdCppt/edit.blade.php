<form action="{{ route('igd/cppt.update', $item->id) }}" method="POST">
    @csrf
    @method('PUT')
    <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="mb-3">
            ...
            <textarea class="form-control" id="editor" rows="2" name="soap">{{ $item->soap }}</textarea>
          </div>
          <div class="mb-3">
            <h6>Instruksi Tenaga Kesehatan termasuk Bedah / Prosedur<br>
            <span class="fs-6">(Intrusksi ditulis dengan rinci dan jelas)</span>
            </h6>
            <textarea class="form-control" id="editor1" rows="2" name="intruksi">{{ $item->intruksi }}</textarea>
          </div>
