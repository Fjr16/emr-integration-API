        ...
        <div class="d-flex justify-content-between gap-2">
            <div class="col-6 font-8pt">
                ...
                <div class="content border border-dark p-1 mt-4">
                            ...
                            <div class="mx-3">
                                ...
                                <div class="form-check">
                                    <input name="default-radio-1" class="form-check-input" type="radio"
                                        value="Kunjungan Awal" id="defaultRadio1" style="pointer-events: none;"
                                ...
                                <div class="form-check">
                                    <input name="default-radio-1" class="form-check-input" type="radio"
                                        value="Observasi" id="defaultRadio3" style="pointer-events: none;"
                                ...
                                <div class="form-check">
                                    <input name="default-radio-1" class="form-check-input" type="radio"
                                        value="Post Operasi" id="defaultRadio4" style="pointer-events: none;"
                    ...
                    <table class="table table-bordered border-dark table-sm mb-3">
                        <thead>
                        ...
                        <tbody>
                            @foreach ($item->suratBuktiPelayananPatientDetails as $suratDetail)
                                <tr>
                                    ...
                                    @if (!empty($suratDetail->diagnosa) && !empty($suratDetail->icd) && !empty($suratDetail->nama_tindakan))
                                        <td><img src="{{ Storage::url($suratDetail->ttd ?? '') }}" alt=""
                    ...
                    <table class="table table-bordered border-dark table-sm mb-3">
                        ...
                        <tbody>
                            <tr>
                                <td>Diagnosis Utama : {{ $item->diagnosis_utama }}</td>
                                <td>{{ $item->icdx ?? '' }}</td>
                            </tr>
                            <tr>
                            ...
                            @foreach ($item->suratBuktiPelayananSekunderDiagnosis as $suratSekunderAction)
                                <tr>
                                    <td>{{ $suratSekunderAction->diganosa_name ?? '' }}</td>
                                    <td>{{ $suratSekunderAction->diagnosa_icdx ?? '' }}</td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
                    <table class="table table-bordered border-dark table-sm mb-3">
                        ...
                        <tbody>
                            <tr>
                                <td>Tindakan Utama : {{ $item->tindakan_utama }}</td>
                                <td>{{ $item->icdg ?? '' }}</td>
                            </tr>
                            <tr>
                                <td>Tindakan Tambahan</td>
                ...
                <div class="content border border-dark p-1 mt-4">
                    <div class="row">
                        ...
                        <div class="col-12 mt-3">
                            <div class="mb-3">
                                <label for="editor" class="form-label">Belum dapat di kembalikan ke fasilitas
                                    perujuk dengan
                                    alasan :</label>
                                <p class="mb-0">1. {{ $suratKeterangan->fasilitas_rujukan ?? '' }}</p>
                                <p class="mb-0">2. {{ $suratKeterangan->fasilitas_rujukan_lainnya ?? '' }}</p>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="mb-3">
                                <label for="editor" class="form-label">Rencana tindak lanjut akan dilakukan pada
                                    kunjungan
                                    selanjutnya :</label>
                                <p class="mb-0">1. {{ $suratKeterangan->tindak_lanjut ?? '' }}</p>
                                <p class="mb-0">2. {{ $suratKeterangan->tindak_lanjut_lainnya ?? '' }}</p>
                            </div>
                        </div>
                        <div class="col-12">
                            <table class="w-100">
                                <tbody>
                                    <label for="editor" class="form-label">Rencana tindak lanjut akan dilakukan
                                        pada
                                        kunjungan
                                        selanjutnya :</label>
                                    <tr>
                        ...
                        <div class="col-6">
                            <table class="w-100">
                                <tbody class="text-center">
                                    ...
                                    <tr>
                                        <td>
                                            <img src ="{{ Storage::url($item2->asesmentKeperawatanRencanaAsuhanPatient->ttdppja ?? '') }} "
                                                alt="" width="100">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            {{ $item2->asesmentKeperawatanRencanaAsuhanPatient->namappja ?? '.......................................' }}
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                        ...
                        <div class="col-6">
                            <table class="w-100">
                                <table class="w-100">
                                    <tbody class="text-center">
                                        <tr>
                                            <td class="" style="padding-bottom: 10px">Padang,
                                                {{ date('d-M-Y') }} <br>
