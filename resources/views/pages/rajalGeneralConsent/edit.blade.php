...
@section('content')
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('rajal/general/consent.update', $item->id) }}">
                @csrf
                @method('PUT')
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-7">
                                <select class="form-control select2" name="hubungan" id="hubungan" @required(true)>
                                    @php
                                        $hubLainnya = in_array($item->hubungan, $status) ? false : true;
                                    @endphp
                                    @foreach ($status as $stat)
                                        @if (($hubLainnya ? 'Lainnya' : $item->hubungan) == $stat)
                                ...
                                <input type="text" class="form-control mt-2" name="lainnya" id="inputLainnya" value="{{ $hubLainnya ? $item->hubungan : '' }}"
                                    style="display: {{ $hubLainnya ? 'block' : 'none' }};">
                                            ...
                                            <div class="d-flex flex-row mb-1">
                                                <div class="">
                                                    <div class="d-flex flex-row">
                                                        nama :
                                                        <span class="mx-2">
                                                            <input type="text" class="form-control form-control-sm" value="{{ $detail->name ?? '' }}"
                                                                name="persetujuan_name[]">
                                                        </span>
                                                        hubungan dengan pasien :
                                                        <span class="mx-2">
                                                            <input type="text" class="form-control form-control-sm"
                                                                name="persetujuan_hub[]" value="{{ $detail->hub ?? '' }}">
                                                        </span>
                                                    </div>
                                                </div>
                                                <div class="">
