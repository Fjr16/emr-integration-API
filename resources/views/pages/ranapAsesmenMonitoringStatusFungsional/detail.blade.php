        ...
        <div class="card-header">
            <div class="row">
                ...
                <div class="col-sm-6 text-end">
                    <a href="{{ route('monitoring/status/fungsional.show', $item->id) }}" target="blank" class="btn btn-dark btn-sm"><i class='bx bx-printer'></i></a>
                    <a href="{{ route('monitoring/status/fungsional.create', $item->id) }}" class="btn btn-success btn-sm"><i class='bx bx-plus'></i> Tambah Monitoring Status Fungsional</a>
                </div>
            </div>
        </div>
        <div class="card-body">
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="{{ route('monitoring/status/fungsional.edit', $d->id) }}">
                                            <i class="bx bx-edit-alt me-1"></i>
                                            Edit
                                        </a>
                                        <form action="{{ route('monitoring/status/fungsional.destroy', $d->id) }}"
                                            method="POST">
                                            @csrf
                                            @method('DELETE')
