...
@section('content')
    ...
    <div class="mb-4 card">
        <div class="card-header d-flex align-items-center justify-content-between">
            <h5 class="mb-0">Edit Assesmen PRA Anestesi - PRA Induksi
            </h5>
        </div>
        <form action="{{ route('assesmen/pra/anestesi/pra/induksi.update', $item->id) }}" method="POST"
            ...
            <div class="card-body">
                <div class="mb-3 row">
                    ...
                    <div class="col-4">
                        <input type="date" name="tanggal" id="tglAssesment" class="form-control form-control-sm"
                            value="{{ $tanggal_asesment->format('Y-m-d') }}">
                    </div>
                </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-9">
                                        <input class="form-control form-control-sm" type="text" id="asistenAnestesi"
                                            value="{{ $item->asisten_anestesi ?? '' }}" name="asisten_anestesi" />
                                    </div>
                                </div>
                                <div class="row">
                        ...
                        <div class="col">
                            <div class="p-2">
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-8">
                                        <input class="form-control form-control-sm" type="text" id="diagnosisPraBedah"
                                            value="{{ $item->diagnosis_pra_bedah ?? '' }}" name="diagnosis_pra_bedah" />
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    <label for="jenisPembedahan" class="col-form-label col-4">Jenis Pembedahan</label>
                                    <div class="col-8">
                                        <input class="form-control form-control-sm" type="text" id="jenisPembedahan"
                                            value="{{ $item->jenis_pembedahan ?? '' }}" name="jenis_pembedahan" />
                                    </div>
                                </div>
                                <div class="row">
                                    <label for="diagnosisPascaBedah" class="col-form-label col-4">Diagnosis Pasca
                                        Bedah</label>
                                    <div class="col-8">
                                        <input class="form-control form-control-sm" type="text" id="diagnosisPascaBedah"
                                            value="{{ $item->diagnosis_pasca_bedah ?? '' }}"
                                            name="diagnosis_pasca_bedah" />
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="mb-4 col">
                                    ...
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col">
                                            <input type="time" class="form-control form-control-sm"
                                                id="rencanaOperasiJam" value="{{ $item->jam_operasi ?? '' }}"
                                                name="jam_operasi">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="form-check col">
                                            <input name="alergi-obat" class="form-check-input" type="checkbox"
                                                ...
                                                {{ in_array('ASA', $statusFisikArr) ? 'checked' : '' }} />
                                        ...
                                        <div class="form-check col">
                                            <input class="form-check-input" type="checkbox" value="1"
                                                ...
                                                {{ in_array('1', $statusFisikArr) ? 'checked' : '' }} />
                                        ...
                                        <div class="form-check col">
                                            <input class="form-check-input" type="checkbox" value="2"
                                                ...
                                                {{ in_array('2', $statusFisikArr) ? 'checked' : '' }} />
                                        ...
                                        <div class="form-check col">
                                            <input class="form-check-input" type="checkbox" value="3"
                                                ...
                                                {{ in_array('3', $statusFisikArr) ? 'checked' : '' }} />
                                        ...
                                        <div class="form-check col">
                                            <input class="form-check-input" type="checkbox" value="4"
                                                ...
                                                {{ in_array('4', $statusFisikArr) ? 'checked' : '' }} />
                                        ...
                                        <div class="form-check col">
                                            <input class="form-check-input" type="checkbox" value="5"
                                                ...
                                                {{ in_array('5', $statusFisikArr) ? 'checked' : '' }} />
                                        ...
                                        <div class="form-check col">
                                            <input class="form-check-input" type="checkbox" value="E"
                                                ...
                                                {{ in_array('E', $statusFisikArr) ? 'checked' : '' }} />
                            ...
                            <div class="mb-3 row align-items-center">
                                ...
                                <div class="col-8">
                                    <input type="time" class="form-control form-control-sm" id="puasaMulaiJam"
                                        value="{{ $item->puasa_jam ?? '' }}" name="puasa_jam">
                                </div>
                            </div>
                            <div class="row align-items-center">
                    ...
                    <div class="row">
                        ...
                        <div class="col-10">
                            <textarea class="form-control" id="editor" rows="3" name="penyulit_pra_anestesi">{!! $item->penyulit_pra_anestesi ?? '' !!}</textarea>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="col">
                                <div class="form-check">
                                    <input name="anestesi_checklist[]" class="form-check-input" type="checkbox"
                                        ...
                                        {{ in_array($ceklist, $item->ranapAssesmenPraAnestesiChecklists->pluck('name')->toArray()) ? 'checked' : '' }} />
                                ...
                                @if ($loop->iteration % 2 == 0)
                                    <div class="form-check">
                                        <input name="anestesi_technique[]" class="form-check-input" type="checkbox"
                                            ...
                                            {{ in_array($teknik, $item->ranapAssesmenPraAnestesiTechniques->pluck('name')->toArray()) ? 'checked' : '' }} />
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-6">
                                            <input class="form-control form-control-sm input-anestesi" type="text"
                                                name="anestesi_teknik_temp_value[]"
                                                value="{{ $item->ranapAssesmenPraAnestesiTechniques->where('name', $teknik)->pluck('name')->first() }}"
                                                {{ in_array($teknik, $item->ranapAssesmenPraAnestesiTechniques->pluck('name')->toArray()) ? '' : 'disabled' }} />
                                        </div>
                                    </div>
                                @endif
                            </div>
                ...
                <div class="mb-4 col border-bottom">
                    ...
                    <div class="pb-3 col" id="specialTool">
                        @if (in_array('Hipotensi', $item->ranapAssesmenPraAnestesiSpecialTools->pluck('name')->toArray()))
                            @foreach ($item->ranapAssesmenPraAnestesiSpecialTools as $specialTool)
                                @if ($specialTool->name == 'Hipotensi')
                                    <div class="form-check">
                                        <input name="special_tool[]" class="form-check-input" type="checkbox"
                                            value="{{ $specialTool->name ?? '' }}" id="Hipotensi"
                                            @checked(true) />
                                    ...
                                    <div class="row mb-2">
                                        <div class="col-2">
                                            <input class="form-control form-control-sm" type="text"
                                                name="special_tool[]" value="{{ $specialTool->name ?? '' }}" />
                                        </div>
                                    </div>
                                @endif
                            @endforeach
                ...
                <div class="mb-4 col border-bottom">
                    ...
                    <div class="pb-3 row row-cols-6" id="partMonitoring">
                            ...
                            <div class="col mb-2">
                                <div class="form-check">
                                    <input name="monitoring[]" class="form-check-input" type="checkbox"
                                        ...
                                        {{ in_array($monitoring, $item->ranapAssesmenPraAnestesiMonitorings->pluck('name')->toArray()) ? 'checked' : '' }} />
                        ...
                        @endforeach
                        @foreach ($item->ranapAssesmenPraAnestesiMonitorings as $monitoring)
                            @if (!in_array($monitoring->name, $dataMonitoring))
                                <div class="col mb-2">
                                    <div class="row">
                                        <div class="col-9">
                                            <input class="form-control form-control-sm" type="text"
                                                value="{{ $monitoring->name ?? '' }}" name="monitoring[]" />
                                        </div>
                                    </div>
                                </div>
                            @endif
                ...
                <div class="mb-4 col border-bottom">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-4">
                            <input class="form-control form-control-sm" type="text"
                                value="{{ $item->ranapAssesmenPraAnestesiInductions->keluhan ?? '' }}" name="keluhan"
                                id="Keluhan" />
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <div class="col-6">
                            <div class="row">
                                ...
                                <div class="col-8">
                                    <input class="form-control form-control-sm" type="text"
                                        value="{{ $item->ranapAssesmenPraAnestesiInductions->kesadaran ?? '' }}"
                                        id="kesadaran" name="kesadaran" />
                                </div>
                            </div>
                        </div>
                        <div class="col">
                            <div class="row">
                                <div class="col">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <input class="form-control form-control-sm me-2" type="number"
                                            value="{{ $item->ranapAssesmenPraAnestesiInductions->td ?? '' }}"
                                            id="TD" name="td" style="max-width: 200px;" />
                                        <span>mmHg</span>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <input class="form-control form-control-sm me-2" type="number"
                                            value="{{ $item->ranapAssesmenPraAnestesiInductions->hr ?? '' }}"
                                            id="HR" name="hr" style="max-width: 200px;" />
                                        <span>x/mnt</span>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <input class="form-control form-control-sm me-2" type="number"
                                            value="{{ $item->ranapAssesmenPraAnestesiInductions->rr ?? '' }}"
                                            id="RR" name="rr" style="max-width: 200px;" />
                                        <span>x/mnt </span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col">
                            <div class="row align-items-center">
                                ...
                                <div class="col-2">
                                    <div class="d-flex align-items-center">
                                        <input class="form-control form-control-sm me-2" type="number"
                                            value="{{ $item->ranapAssesmenPraAnestesiInductions->temperature ?? '' }}"
                                            id="temperatur" name="temperature" />
                                        <span>C</span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col">
                            <div class="row align-items-center">
                                ...
                                <div class="col-2">
                                    <div class="d-flex align-items-center">
                                        <input class="form-control form-control-sm me-2" type="number"
                                            value="{{ $item->ranapAssesmenPraAnestesiInductions->saturasi ?? '' }}"
                                            id="saturasiO2" name="saturasi" />
                                        <span>%</span>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-10">
                            <textarea class="form-control" id="editor1" name="lainnya">{!! $item->ranapAssesmenPraAnestesiInductions->lainnya ?? '' !!}</textarea>
                        </div>
                    </div>
                    {{-- tanda tangan --}}
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-3 text-center">
                            <img src="{{ Storage::Url($item->ttd_dokter_anestesi ?? '') }}" alt=""
                                id="ttdImage" class="border">
                    ...
                    <div class="row mb-5">
                        ...
                        <div class="col-3 text-center">
                            <input type="text" class="form-control form-control-sm text-center" id="nama_user"
                                value="" name="nama_dokter_anestesi" placeholder="Nama Lengkap" @readonly(true)>
                        </div>
                    </div>
                </div>
