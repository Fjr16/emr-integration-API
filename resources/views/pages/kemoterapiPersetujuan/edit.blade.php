...
@section('content')
    ...
    <div class="card p-3 mt-5 ">
        ...
        <div class="d-flex">
            <h4 class="align-self-center m-0">PEMBERIAN INFORMASI DAN
                PERSETUJUAN TINDAKAN KEMOTERAPI {{ $item->kemoterapiPatient->queue->patient->name }}
            </h4>
            {{-- <div class="ms-auto">
        ...
        <form action="{{ route('kemoterapi/persetujuan.update', $item->id) }}" method="POST"
            ...
            <div class="card-body">
                ...
                <div>
                    <div class="row">
                        <table class=" table table-bordered m-0 mt-3 p-0">
                            ...
                            @foreach ($item->kemoterapiPersetujuanDetail as $jenis)
                                <tr>
                                    ...
                                    <td class="w-50" id="row-ttd-pasien">
                                        <img src="{{ Storage::url($jenis->ttd) }}" alt=""
                                            id="ttdImage{{ $loop->iteration }}">
                            ...
                            <tr>
                                ...
                                <td class="w-50" id="row-ttd-pasien">
                                    ...
                                    <textarea id="ttd{{ $parameter }}" name="ttd[]" style="display: none;">{{ $jenis->ttd }}</textarea>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="3">
                ...
                <h3 class="bg-dark py-1 text-white text-center">PERSETUJUAN TINDAKAN KEMOTERAPI
                </h3>
                <div>
                    <div id="form-dinamis">
                        <div class="row w-100">
                    ...
                    <div class="row mt-4 ">
                        <div class="col-12 d-flex ">
                            dengan ini menyatakan persetujuan untuk dilakukannya tindakan kemoterapi melalui:
                        </div>
                        <div class="d-flex flex-row mt-2">
                            <div class="mx-2">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="tindakan"
                                        id="flexRadioDefault1" value="Oral"
                                        {{ $item->keterangan == 'Oral' ? 'checked' : '' }}>
                            ...
                            <div class="mx-2">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="tindakan"
                                        id="flexRadioDefault2" value="Intravena"
                                        {{ $item->keterangan == 'Intravena' ? 'checked' : '' }}>
                            ...
                            <div class="mx-2">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="tindakan"
                                        ...
                                        {{ $item->keterangan != ['Intravena', 'Oral'] ? 'checked' : '' }}>
                                    <input type="text" class="form-control" name="inputTindakan"
                                        value="{{ $item->tindakan }}">
                                </div>
                            </div>
                        </div>
                        <div class="col-12 mt-4">
                            <div class="d-flex flex-row">
                                @if ($item->hubungan == 'saya')
                                    <div class="">
                                        terhadap <input class="form-check-input mx-1" type="radio" id="saya"
                                            value="saya" name="hubungan" onclick="disableHubungan()" checked />
                                        <label class="form-check-label" for="saya"> saya</label> /
                                    </div>
                                    <div class="">
                                        <div class="d-flex flex-row">
                                            <div class="">
                                                <input class="form-check-input col-2 mx-1" type="radio"
                                                    id="radio_hubungan" value="" onclick="enableHubungan()" />
                                            </div>
                                            <div class="">
                                                <p class="col d-flex">
                                                    <input type="text" class="form-control form-control-sm"
                                                        id="input_hubungan" disabled name="hubungan"
                                                        onchange="transferValueHubungan(this.value)">
                                                </p>
                                            </div>
                                        @else
                                            <div class="">
                                                terhadap <input class="form-check-input mx-1" type="radio"
                                                    id="saya" value="saya" name="hubungan"
                                                    onclick="disableHubungan()" />
                                                <label class="form-check-label" for="saya"> saya</label> /
                                            </div>
                                            <div class="">
                                                <div class="d-flex flex-row">
                                    ...
                                    <div class="d-flex flex-row">
                                        ...
                                        <div class="ms-2">
                                            <input class=" m-0 form-control form-control-sm d-flex" type="text"
                                                value="{{ $item->kemoterapiPatient->queue->patient->name }}" disabled />
                                        </div>
                                        <div class="ms-2">
                                        ...
                                        <div class="ms-2">
                                            <input class=" m-0 form-control form-control-sm " type="text"
                                                value="{{ $item->kemoterapiPatient->queue->patient->jenis_kelamin }}"
                                                disabled />
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="col-12">
                    <div class="d-flex flex-row">
                        ...
                        <div class="col-7">
                            <input type="text" class="form-control form-control-sm"
                                value="{{ $item->kemoterapiPatient->queue->patient->alamat }}" disabled>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="d-flex flex-row">
        <div class="">Padang, Tanggal</div>
        @php
            $tanggal = $item->tanggal;
            $date = Carbon\Carbon::parse($tanggal)->format('Y-m-d');
            $time = Carbon\Carbon::parse($tanggal)->format('H:i');
        @endphp
        <div class="ms-2"><input type="date" name="date" class="form-control form-control-sm"
                value="{{ $date }}"></div>
        <div class="ms-3">Pukul</div>
        <div class="ms-2"> <input type="time" name="time"
                class="form-control form-control-sm" value="{{ $time }}">
        </div>
    </div>
    <div class="row mb-3">
        <div class="col-7"></div>
        <div class="col-5 ps-5">Saksi</div>
    </div>
    <div class="row mb-5">
        ...
        <div class="col-4">
            <div class="row">
                ...
                <div class="col-7">
                    <input type="text" name="hub1" class="form-control form-control-sm"  value="{{ $item->hub1 }}">
                </div>
            </div>
        </div>
        <div class="col-4">
            <div class="row">
                ...
                <div class="col-7">
                    <input type="text" name="hub2" class="form-control form-control-sm"  value="{{ $item->hub2 }}">
                </div>
            </div>
        </div>
    </div>
        ...
        function TruePasien() {
            ...
            formDinamis.innerHTML = `
                        <div class="row w-100">
                            <p class="col-auto">Yang bertandatangan di bawah ini, saya , nama</p>
                            <span class="col-6">
                                <input class="m-0 form-control form-control-sm " type="text" value="{{ $item->kemoterapiPatient->queue->patient->name }}" readonly/>
                            </span>
                            <p class="col-auto">, umur</p>
                            <span class="col-1">
                        ...
                        <div class="row">
                            <div class="d-flex col-3">
                                <input class=" m-0 form-control form-control-sm " type="text" value="{{ $item->kemoterapiPatient->queue->patient->jenis_kelamin }}" name="jenis_kelamin" readonly/>
                            </div>
                            <span class="col-1">alamat,</span>
                            <div class="col-8 ">
                                <input type="text" class="form-control form-control-sm" name="alamat" value="{{ $item->kemoterapiPatient->queue->patient->alamat }}" readonly>
                            </div>
                        </div>
            `;
            var namaPenerimaInfo = document.getElementById('namaPenerimaInformasi');
            namaPenerimaInfo.value = "{{ $item->kemoterapiPatient->queue->patient->name ?? '' }}";
        }
