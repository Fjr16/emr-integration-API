    ...
    <div class="card p-3 mt-5 ">
        ...
        <div class="d-flex">
            <h4 class="align-self-center m-0">PEMBERIAN INFORMASI DAN
                PERSETUJUAN TINDAKAN KEMOTERAPI {{ $item->queue->patient->name }}
            </h4>
            {{-- <div class="ms-auto">
        ...
        <form action="{{ route('kemoterapi/persetujuan.store', $item->id) }}" method="POST"
            ...
            <div class="card-body">
                        ...
                        <div class="col">
                            <div class="form-check form-check-inline mt-3 ">
                                <input class="form-check-input" type="radio" name="name" id="isPasien"
                                    value="{{ $item->queue->patient->name }}" onclick="TruePasien()" />
                            ...
                            <div class="form-check form-check-inline mt-3 ">
                                <input class="form-check-input" type="radio" id="radio_notPasien" name="name"
                                    onclick="notPasien()" />
                                <input type="text" class="form-control form-control-sm" id="input_notPasien" disabled
                                    onchange="tfValueNotPasien(this.value)">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <table class=" table table-bordered m-0 mt-3 p-0">
                            ...
                            @foreach ($jenisInformasi as $jenis)
                                <tr>
                                    ...
                                    <td class="w-50" id="row-ttd-pasien">
                                        <img src="" alt="" id="ttdImage{{ $loop->iteration }}">
                                        <button type="button" class="col-12 btn btn-sm btn-dark"
                                            onclick="openModal(this, {{ $loop->iteration }})">Paraf</button>
                                        <textarea id="ttd{{ $loop->iteration }}" name="ttd[]" style="display: none;"></textarea>
                                    </td>
                                </tr>
                                @php
                                    $ttd = $loop->iteration;
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <img src="" alt="" id="imgTtdKet1">
                                    <textarea id="ttdKet1" name="ttdKet1" style="display: none;"></textarea>
                                    <button type="button" class="col-12 btn btn-sm btn-dark"
                                        onclick="openModalTtdBottom(this, 'imgTtdKet1', 'ttdKet1')">Tanda Tangan
                                        Petugas</button>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <img src="" alt="" id="imgTtdKet2">
                                    <textarea id="ttdKet2" name="ttdKet2" style="display: none;"></textarea>
                                    <button type="button" class="col-12 btn btn-sm btn-dark"
                                        onclick="openModalTtdBottom(this, 'imgTtdKet2', 'ttdKet2')">Tanda Tangan
                                        Penerima</button>
                                </td>
                            </tr>
                        </table>
                            ...
                            <div class="mx-2">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="tindakan"
                                        id="flexRadioDefault1" value="Oral" checked>
                            ...
                            <div class="d-flex flex-row">
                                <div class="">
                                    terhadap <input class="form-check-input mx-1" type="radio" id="saya"
                                        value="saya" name="hubungan" onclick="disableHubungan()" />
                                    ...
                                    <div class="d-flex flex-row">
                                        ...
                                        <div class="ms-2">
                                            <div class="d-flex flex-row">
                                                ...
                                                <div class="ms-2">
                                                    <input class=" m-0 form-control form-control-sm " type="text"
                                                        value="{{ $item->queue->patient->jenis_kelamin }}" disabled />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="d-flex flex-row">
                    ...
                    <div class="ms-2"><input type="date" name="date" class="form-control form-control-sm"></div>
                ...
                <div class="row mb-5">
                    <div class="col-4 text-center">
                        <input type="text" class="form-control form-control-sm" name="namaPenerimaInformasi"
                            placeholder="Nama Lengkap" id="namaPenerimaInformasi" @readonly(true)>
                    </div>
                    <div class="col-4 text-center">
        ...
        function TruePasien() {
            ...
            formDinamis.innerHTML = `
                        <div class="row w-100">
                            <p class="col-auto">Yang bertandatangan di bawah ini, saya , nama</p>
                            <span class="col-6">
                                <input class="m-0 form-control form-control-sm " type="text" value="{{ $item->queue->patient->name }}" readonly/>
                            </span>
                            <p class="col-auto">, umur</p>
                            <span class="col-1">
                        ...
                        <div class="row">
                            <div class="d-flex col-3">
                                <input class=" m-0 form-control form-control-sm " type="text" value="{{ $item->queue->patient->jenis_kelamin }}" name="jenis_kelamin" readonly/>
                            </div>
                            <span class="col-1">alamat,</span>
                            <div class="col-8 ">
                                <input type="text" class="form-control form-control-sm" name="alamat" value="{{ $item->queue->patient->alamat }}" readonly>
                            </div>
                        </div>
            `;
            var namaPenerimaInfo = document.getElementById('namaPenerimaInformasi');
            namaPenerimaInfo.value = "{{ $item->queue->patient->name ?? '' }}";
        }
