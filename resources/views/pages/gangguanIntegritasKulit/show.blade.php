...
<head>
    ...
    <title>Print Gangguan Integritas Kulit</title>
            ...
            <table class="table-bordered">
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="small">
                            <p class="text-center fw-bold mb-2">Gangguan Integritas Kulit/jaringan</p>
                            ...
                            <div class="">
                                ...
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="flexCheckDefault13">
                                        Faktor mekanis (penekanan pada tonjolan tulang, gesekan/luka operasi), faktor
                            ...
                            <p class="text-center fw-bold mt-4 mb-0"><i>dibuktikan dengan</i></p>
                            <div class="">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value=""
                        ...
                        <td class="small">
                            <p class="mb-0">Setelah dilakukan intervensi keperawatan selama ... jam, maka penyembuhan
                                luka meningkat,
                                dengan
                                kriteria hasil : </p>
                            <div class="form-check">
                        ...
                        <td class="small">
                            <p class="fw-bold mb-0">Perawat Luka</p>
                        ...
                        <td class="small">
                            <p class="fw-bold mb-0">Gangguan Integritas Kulit/Jaringan :</p>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value=""
