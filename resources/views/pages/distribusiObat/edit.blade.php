...
<div class="card mb-4">
  ...
  <div class="card-body">
      <form method="POST" action="{{ route('farmasi/obat/pembelian/faktur.update', $item->id) }}">
        @method('PUT')
        @csrf
          <hr class="m-0 mb-3">
          <div class="row mb-3">
          ...
          <div class="row mb-3">
            ...
            <label class="col-sm-2 col-form-label" for="basic-default-name">Status Pembelian</label>
            <div class="col-sm-4">
