...
@section('content')
    <style>
        ...
        .left-btn {
            left: 0;
            top: 0;
            background: linear-gradient(to left, transparent, rgb(161, 161, 161) 150%);
        ...
        .right-btn {
            right: 0;
            top: 0;
            background: linear-gradient(to right, transparent, rgb(161, 161, 161) 150%);
                ...
                <ul class="tab-menu">
                    ...
                    {{-- <li class="nav-item">
                        <button id="btn-link" type="button"
                            ...
                            role="tab" data-bs-toggle="tab" data-bs-target="#navs-justified-gc"
                            aria-controls="navs-justified-gc" aria-selected="true">
                            <i class="tf-icons bx bx-bookmark-alt-plus"></i>
                    ...
                    {{-- @can('surat persetujuan pelayanan pasien form ranap')
                            ...
                            @endcan --}} {{-- @can('ringkasan masuk dan keluar form ranap')
                            <li class="nav-item">
                            <button
                                id="btn-link"
                                type="button"
                    ...
                    @can('monitoring status fungsional form ranap')
                        <li class="tab-btn">
                            <button id="btn-link" type="button" {{-- @dd(session()->all()) --}}
                                ...
                                data-bs-target="#navs-justified-monitoringstatusfungsional"
                    ...
                    @can('asesmen pra anestesi-induksi form ranap')
                        <li class="tab-btn">
                            <button id="btn-link" type="button" {{-- @dd(session()->all()) --}}
                                ...
                                role="tab" data-bs-toggle="tab"
                                data-bs-target="#navs-justified-asesmenpraanestesi-induksi"
        ...
        <div class="tab-content">
                                        ...
                                        @if ($item->skriningCovidRanapPatient)
                                            ...
                                            @if ($item->skriningCovidRanapPatient->total_skor > 4)
                                                <td class="text-center"><a
                                                        ...
                                                        class="btn btn-sm btn-success"><i class="bx bx-plus"></i></a></td>
                                            @else
            ...
            <div class="tab-pane fade {{ session('btn') == 'monitoring-pacu' ? 'show active' : '' }}"
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="text-end mb-3">
                            <a class="btn btn-success btn-sm" href="/create-monitoring-pacu">+ Tambah Monitoring Pacu</a>
                        </div>
                        <div class="card">
                            <table class="table">
                                <thead>
            ...
            <div class="tab-pane fade {{ session('btn') == 'hais' ? 'show active' : '' }}" id="navs-justified-hais"
                role="tabpanel">
                <div class="text-end mb-3">
                    <a class="btn btn-success btn-sm" href="/pencegahan-infeksi-saluran-kemih">+ Tambah Pencegahan ISK</a>
                    <a class="btn btn-success btn-sm" href="/pencegahan-infeksi-aliran-darah">+ Tambah Pencegahan IAD</a>
            ...
            <div class="tab-pane fade {{ session('btn') == 'monitoringstatusfungsional' ? 'show active' : '' }}"
                ...
                <div class="text-end mb-3">
                    <a href="{{ route('monitoring/status/fungsional.show', $item->id) }}" target="blank"
                        class="btn btn-dark btn-sm"><i class='bx bx-printer'></i></a>
                    <a class="btn btn-success btn-sm"
                        href="{{ route('monitoring/status/fungsional.create', $item->id) }}">+
                        Tambah Monitoring Status
                        Fungsional</a>
                </div>
                <div class="card">
                    <table class="table">
            ...
            <div class="tab-pane fade {{ session('btn') == 'laporananestesi' ? 'show active' : '' }}"
                ...
                <div class="text-end mb-3">
                    <a class="btn btn-success btn-sm" href="{{ route('laporan/anestesi.create', $item->id) }}">+ Tambah
                        Laporan Anestesi</a>
                </div>
                <div class="card">
                    <table class="table">
