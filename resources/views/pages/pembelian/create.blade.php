              ...
              <div class="row">
                ...
                <div class="col-sm-2">
                  <label class="row-sm-1 col-form-label form-label-sm" for="basic-default-name">Jumlah Obat</label>
                    <input type="number" id="jumlah_awal" class="form-control" value="{{ old('jumlah_awal') }}" onkeyup="enableSatuanAwal(this)" @disabled(true) required />
                </div>
                <div class="col-sm-2">
                    <label class="row-sm-1 col-form-label form-label-sm" for="basic-default-name">Satuan Obat</label>
                    <select class="form-select" id="satuan_awal" aria-label="Default select example" onfocus="getSatuan(this)" @disabled(true)>
                        <option selected disabled>Pilih</option>
