...
<div class="card p-3 mt-5">
  <div class="row">
    <div class="col-md-10">
        ...
        <div class="col-md-2">
          <a class="btn btn-success btn-sm text-white" href="{{ route('checklist/rencana/pulang/page/one.create', $item->id) }}"><i class="bx bx-plus"></i>Tambah Discharge Planning</a>
      </div>
  </div>
            ...
            <td>
              ...
              <div class="dropdown">
                ...
                <div class="dropdown-menu">
                  <a class="dropdown-item" href="{{ route('checklist/rencana/pulang/page/one.edit', $dis->id) }}">
                    <i class="bx bx-plus"></i>
                    Edit
                  </a>
                  <a class="dropdown-item" href="{{ route('checklist/rencana/pulang/page/one.print', $dis->id) }}">
                    <i class="bx bx-printer"></i>
                    Print
                  </a>
                  <form action="{{ route('checklist/rencana/pulang/page/one.destroy', $dis->id) }}" method="POST">
                    @method('DELETE')
                    @csrf
