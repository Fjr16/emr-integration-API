                                            ...
                                            <div class="d-flex flex-row">
                                                <div class="form-check d-flex">
                                                    <input class="form-check-input" type="checkbox" id=""
                                                        value="Lainnya-2" name="Lainnya-2">
                                                    <label class="form-check-label ms-2">
                                                        tulis disini lainnya
                                                    </label>
                                                </div>
                                    ...
                                    <td>
                                        ...
                                        <div class="mb-0">
                                            <div class="d-flex flex-row">
                                                <div class="form-check d-flex">
                                                    <input class="form-check-input" type="checkbox" id=""
                                                        value="Lainnya-3" name="Lainnya-3"
                                                        onchange="toggleRadioVisibility(this, 'Lainnya-Radio')">
                            ...
                            <div class="form-check d-flex flex-column">
                                ...
                                <div class="mb-0">
                                    <div class="d-flex flex-row">
                                        <div class="form-check d-flex">
                                            <input class="form-check-input" type="checkbox" id=""
                                                value="Lainnya-4" name="Lainnya-4"
                                                onchange="toggleRadioVisibility(this, 'Lainnya-Radio')">
                                            <label class="form-check-label ms-2" for="">
                                                tulis disini lainnya
                                            </label>
                                    ...
                                    <td>
                                        ...
                                        <div class="mb-0">
                                            <div class="d-flex flex-row">
                                                <div class="form-check d-flex">
                                                    <input class="form-check-input" type="checkbox" id=""
                                                        value="Lainnya-5" name="Lainnya-5"
                                                        onchange="toggleRadioVisibility(this, 'Lainnya-Radio')">
                                                    <label class="form-check-label ms-2" for="">
                                                        tulis disini lainnya
                                                    </label>
