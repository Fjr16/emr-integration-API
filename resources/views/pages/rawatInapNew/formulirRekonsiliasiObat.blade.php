...
@section('content')
    ...
    <div class="card">
                ...
                <ul class="nav nav-tabs nav-sm nav-fill" role="tablist">
                    <li class="nav-item">
                        <button id="btn-link" type="button" {{-- @dd(session()->all()) --}}
                            class="nav-link {{ session('btn') == 'Formulir Rekonsiliasi Obat' ? 'active' : '' }} d-flex justify-content-center"
                            role="tab" data-bs-toggle="tab" data-bs-target="#navs-justified-formulir-rekonsiliasi-obat"
                            aria-controls="navs-justified-formulir-rekonsiliasi-obat" aria-selected="true">
                            <i class="tf-icons bx bx-bookmark-alt-plus"></i>
                            <p class="m-0">Formulir Rekonsiliasi Obat</p>
                        </button>
                    </li>
                </ul>
                <div class="tab-content">
                    <div class="tab-pane fade {{ session('btn') == 'Formulir Rekonsiliasi Obat' ? 'show active' : '' }}"
                        id="navs-justified-formulir-rekonsiliasi-obat" role="tabpanel">
                        <div class="row">
                            <div class="col-sm-12">
                                <h6>Daftar Pasien
                                                        ...
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu">
                                                                <a class="dropdown-item"
                                                                    href="{{ route('formulir/rekonsilasi/obat.create', $item->rawatInapPatient->id) }}">
        ...
        {{-- end Formulir Rekonsiliasi Obat --}}
    </div>
@endsection
