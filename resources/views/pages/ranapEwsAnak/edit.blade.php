        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-6">
                    ...
                    <form method="POST" action="{{ route('ews/anak.update', $item->id) }}">
                        @method('PUT')
                        @csrf
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="number" name="total_skor" id="total_skor" class="form-control" id="basic-default-name" value="{{ $item->total_skor ?? '' }}"
                                    readonly>
                            </div>
                            <div class="text-end">
