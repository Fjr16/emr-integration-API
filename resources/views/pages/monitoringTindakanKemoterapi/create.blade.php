...
@section('content')
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form action="{{ route('kemoterapi/monitoring-tindakan.store', $item->id) }}" method="POST">
                @csrf
                <div class="card-body">
                    <p>PREKEMO</p>
                    <div class="mx-5">
                        <div class="row mb-3">
                            ...
                            <div class="col-12 col-lg-10">
                                <input class="form-control" type="number" value="" name="prekemoTD" />
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="Nadi" class="col-form-label col-12 col-md-6 col-lg-2 text-capitalize">Nadi
                                (X/Menit)</label>
                            <div class="col-12 col-lg-10">
                                <input class="form-control" type="number" value="" name="prekemoNadi" />
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="RR" class="col-form-label col-12 col-md-6 col-lg-2 text-capitalize">RR
                                (X/Menit)</label>
                            <div class="col-12 col-lg-10">
                                <input class="form-control" type="number" value="" name="prekemoRR" />
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="Suhu" class="col-form-label col-12 col-md-6 col-lg-2 text-capitalize">Suhu
                                (°C)</label>
                            <div class="col-12 col-lg-10">
                                <input class="form-control" type="number" value="" name="prekemoSuhu" />
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="ruangan" class="col-form-label col-12 col-md-6 col-lg-2 text-capitalize">Nama
                                Perawat</label>
                            <div class="col-12 col-lg-10">
                                <input class="form-control" type="text" value="" name="prekemoNamaPerawat" />
                            </div>
                        </div>
                        <div class="row mb-3">
                            ...
                            <div class="col-12 col-lg-10">
                                ...
                                <div class="row">
                                    <div class="col-12 col-lg-5">
                                        <div class="form-check">
                                            <input class="form-check-input mt-2" type="checkbox" id="check1"
                                                name="prekemoCheck[]" value="Cairan NaCl 0,9 %" />
                                            <div class="d-flex flex-row">
                                                <label class="pt-2 col-form-label text-capitalize" for="check1">Cairan
                                                    NaCl 0,9 % </label>
                                                <div class="ms-2"><input class="form-control" type="number"
                                                        value="" name="prekemoInput[]" />
                                                </div>
                                ...
                                <div class="row">
                                    <div class="col-12 col-lg-5">
                                        <div class="form-check">
                                            <input class="form-check-input mt-2" type="checkbox" id="check2"
                                                name="prekemoCheck[]" value="Injeksi Dexametasone 5 mg / 1 amp" />
                                            <div class="d-flex flex-row">
                                                <label class="pt-2 col-form-label text-capitalize" for="check2">Injeksi
                                                    Dexametasone 5 mg /
                                                    1
                                                    amp</label>
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-12 col-lg-5">
                                        <div class="form-check">
                                            <input class="form-check-input mt-2" type="checkbox" id="check3"
                                                name="prekemoCheck[]" value="Injeksi Ranitidine 50 mg / 1 amp" />
                                            <div class="d-flex flex-row">
                                                <label class="pt-2 col-form-label text-capitalize" for="check3">Injeksi
                                                    Ranitidine 50 mg /
                                                    1
                                                    amp</label>
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-12 col-lg-5">
                                        <div class="form-check">
                                            <input class="form-check-input mt-2" type="checkbox" id="check4"
                                                name="prekemoCheck[]" value="Injeksi Ondansentrone 8 mg / 1 amp" />
                                            <div class="d-flex flex-row">
                                                <label class="pt-2 col-form-label text-capitalize" for="check4">Injeksi
                                                    Ondansentrone 8 mg
                                                    / 1
                                                    amp</label>
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-12 col-lg-5">
                                        <div class="form-check">
                                            <input class="form-check-input mt-2" type="checkbox" id="check5"
                                                name="prekemoCheck[]" value="Injeksi Diphenhidramine 10 mg / 1 amp" />
                                            <div class="d-flex flex-row">
                                                <label class="pt-2 col-form-label text-capitalize" for="check5">Injeksi
                                                    Diphenhidramine 10
                                                    mg
                                                    / 1 amp</label>
                                            </div>
                    ...
                    <div class="mx-5">
                        <div class="row mb-3">
                            <label for="TD" class="col-form-label col-12 col-md-6 col-lg-2 text-capitalize">TD
                                (MmHg)</label>
                            <div class="col-12 col-lg-10">
                                <input class="form-control" type="number" value="" name="intrakemoTD" />
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="Nadi" class="col-form-label col-12 col-md-6 col-lg-2 text-capitalize">Nadi
                                (X/Menit)</label>
                            <div class="col-12 col-lg-10">
                                <input class="form-control" type="number" value="" name="intrakemoNadi" />
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="RR" class="col-form-label col-12 col-md-6 col-lg-2 text-capitalize">RR
                                (X/Menit)</label>
                            <div class="col-12 col-lg-10">
                                <input class="form-control" type="number" value="" name="intrakemoRR" />
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="Suhu" class="col-form-label col-12 col-md-6 col-lg-2 text-capitalize">Suhu
                                (°C)</label>
                            <div class="col-12 col-lg-10">
                                <input class="form-control" type="number" value="" name="intrakemoSuhu" />
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="ruangan" class="col-form-label col-12 col-md-6 col-lg-2 text-capitalize">Nama
                                Perawat</label>
                            <div class="col-12 col-lg-10">
                                <input class="form-control" type="text" value="" name="intrakemoNamaPerawat" />
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-12 col-lg-10">
                                ...
                                <div class="row">
                                    <div class="col-12 col-lg-5">
                                        <div class="form-check">
                                            <input class="form-check-input mt-2" type="checkbox" id="check6"
                                                value="Bilas cairan NaCl 0,9 %" name="intrakemoCheck[]" />
                                            <div class="d-flex flex-row">
                                                <label class="pt-2 col-form-label text-capitalize" for="check6">Bilas
                                                    cairan NaCl 0,9 %
                                                </label>
                                                <div class="ms-2"><input class="form-control" type="number"
                                                        name="intrakemoInput[]" />
                                ...
                                <div class="row">
                                    <div class="col-12 col-lg-5">
                                        <div class="form-check">
                                            <input class="form-check-input mt-2" type="checkbox" id="check7"
                                                value="Docetaxel" name="intrakemoCheck[]" />
                                            <div class="d-flex flex-row">
                                                <label class="pt-2 col-form-label text-capitalize"
                                                    for="check7">Docetaxel</label>
                                                <div class="ms-2"><input class="form-control" type="number"
                                    ...
                                    <div class="col-12 col-lg-5">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="check8"
                                                value="Brexel" name="intrakemoCheck[]" />
                                            <div class="d-flex flex-row">
                                                <label class="pt-2 col-form-label text-capitalize"
                                                    for="check8">Brexel</label>
                                                <div class="ms-2"><input class="form-control" type="number"
                                                        value="" name="intrakemoInput[]" />
                                                </div>
                                ...
                                <div class="row">
                                    <div class="col-12 col-lg-5">
                                        <div class="form-check">
                                            <input class="form-check-input mt-2" type="checkbox" id="check9"
                                                value="Novelbin / Vinocal" name="intrakemoCheck[]" />
                                            <div class="d-flex flex-row">
                                                <label class="pt-2 pt-lg-0 col-form-label text-capitalize"
                                                    for="check9">Novelbin / Vinocal
                                                </label>
                                                <div class="ms-2"><input class="form-control" type="number"
                                                        value="" name="intrakemoInput[]" />
                                                </div>
                                ...
                                <div class="row">
                                    <div class="col-12 col-lg-5">
                                        <div class="form-check">
                                            <input class="form-check-input mt-2" type="checkbox" id="check10"
                                                value="Bilas cairan NaCl 0,9 %" name="intrakemoCheck[]" />
                                            <div class="d-flex flex-row">
                                                <label class="pt-2 col-form-label text-capitalize" for="check10">Bilas
                                                    cairan NaCl 0,9 %
                                                </label>
                                                <div class="ms-2"><input class="form-control" type="number"
                                                        value="" name="intrakemoInput[]" />
                                ...
                                <div class="row">
                                    <div class="col-12 col-lg-5">
                                        <div class="form-check">
                                            <input class="form-check-input mt-2" type="checkbox" id="check11"
                                                value="Doxorubicin" name="intrakemoCheck[]" />
                                            <div class="d-flex flex-row">
                                                <label class="pt-2 col-form-label text-capitalize"
                                                    for="check11">Doxorubicin</label>
                                                <div class="ms-2"><input class="form-control" type="number"
                                                        value="" name="intrakemoInput[]" />
                                                </div>
                                                <div class="ms-2 pt-2 pt-lg-0 col-form-label text-capitalize">mg di dalam
                                ...
                                <div class="row">
                                    <div class="col-12 col-lg-5">
                                        <div class="form-check">
                                            <input class="form-check-input mt-2" type="checkbox" id="check12"
                                                value="Epirubicin" name="intrakemoCheck[]" />
                                            <div class="d-flex flex-row">
                                                <label class="pt-2 col-form-label text-capitalize"
                                                    for="check12">Epirubicin</label>
                                                <div class="ms-2"><input class="form-control" type="number"
                                                        value="" name="intrakemoInput[]" />
                                                </div>
                                                <div class="ms-2 pt-2 pt-lg-0 col-form-label text-capitalize">mg di dalam
                                ...
                                <div class="row">
                                    <div class="col-12 col-lg-5">
                                        <div class="form-check">
                                            <input class="form-check-input mt-2" type="checkbox" id="check13"
                                                value="Bilas cairan NaCl 0,9 %" name="intrakemoCheck[]" />
                                            <div class="d-flex flex-row">
                                                <label class="pt-2 col-form-label text-capitalize" for="check13">Bilas
                                                    cairan NaCl 0,9 %
                                                </label>
                                                <div class="ms-2"><input class="form-control" type="number"
                                                        value="" name="intrakemoInput[]" />
                                ...
                                <div class="row">
                                    <div class="col-12 col-lg-5">
                                        <div class="form-check">
                                            <input class="form-check-input mt-2" type="checkbox" id="check14"
                                                value="Zoledronic 4 mg infus" name="intrakemoCheck[]" />
                                            <div class="d-flex flex-row">
                                                <label class="pt-2 col-form-label text-capitalize"
                                                    for="check14">Zoledronic 4 mg infus
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-12 col-lg-5">
                                        <div class="form-check">
                                            <input class="form-check-input mt-2" type="checkbox" id="check15"
                                                value="Bilas cairan NaCl 0,9 %" name="intrakemoCheck[]" />
                                            <div class="d-flex flex-row">
                                                <label class="pt-2 col-form-label text-capitalize" for="check15">Bilas
                                                    cairan NaCl 0,9 %
                                                </label>
                                                <div class="ms-2"><input class="form-control" type="number"
                                                        value="" name="intrakemoInput[]" />
                                ...
                                <div class="row">
                                    <div class="col-12 col-lg-5">
                                        <div class="form-check">
                                            <input class="form-check-input mt-2" type="checkbox" id="check16"
                                                value="Cyclovid 600 mg / 800 mg dalam nacl 250cc"
                                                name="intrakemoCheck[]" />
                                            <div class="d-flex flex-row">
                                                <label class="pt-2 col-form-label text-capitalize" for="check16">Cyclovid
                                                    600 mg / 800 mg
                                                    dalam
                                                    nacl 250cc</label>
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-12 col-lg-5">
                                        <div class="form-check">
                                            <input class="form-check-input mt-2" type="checkbox" id="check17"
                                                value="Bilas cairan NaCl 0,9 %" name="intrakemoCheck[]" />
                                            <div class="d-flex flex-row">
                                                <label class="pt-2 col-form-label text-capitalize" for="check17">Bilas
                                                    cairan NaCl 0,9 %
                                                </label>
                                                <div class="ms-2"><input class="form-control" type="number"
                                                        value="" name="intrakemoInput[]" />
                                ...
                                <div class="row">
                                    <div class="col-12 col-lg-5">
                                        <div class="form-check">
                                            <input class="form-check-input mt-2" type="checkbox" id="check18"
                                                value="Curacil 500 mg /750 mg dalam nacl 250 cc"
                                                name="intrakemoCheck[]" />
                                            <div class="d-flex flex-row">
                                                <label class="pt-2 col-form-label text-capitalize" for="check18">Curacil
                                                    500 mg /750 mg
                                                    dalam
                                                    nacl 250 cc</label>
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-12 col-lg-5">
                                        <div class="form-check">
                                            <input class="form-check-input mt-2" type="checkbox" id="check19"
                                                value="Bilas cairan NaCl 0,9 %" name="intrakemoCheck[]" />
                                            <div class="d-flex flex-row">
                                                <label class="pt-2 col-form-label text-capitalize" for="check19">Bilas
                                                    cairan NaCl 0,9 %
                                                </label>
                                                <div class="ms-2"><input class="form-control" type="number"
                                                        value="" name="intrakemoInput[]" />
                    ...
                    <div class="mx-5">
                        <div class="row mb-3">
                            ...
                            <div class="col-10">
                                <input class="form-control" type="number" value="" name="postkemoTD" />
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="Nadi" class="col-form-label col-2 text-capitalize">Nadi (X/Menit)</label>
                            <div class="col-10">
                                <input class="form-control" type="number" value="" name="postkemoNadi" />
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="RR" class="col-form-label col-2 text-capitalize">RR (X/Menit)</label>
                            <div class="col-10">
                                <input class="form-control" type="number" value="" name="postkemoRR" />
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="Suhu" class="col-form-label col-2 text-capitalize">Suhu (°C)</label>
                            <div class="col-10">
                                <input class="form-control" type="number" value="" name="postkemoSuhu" />
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="ruangan" class="col-form-label col-2 text-capitalize">Nama Perawat</label>
                            <div class="col-10">
                                <input class="form-control" type="text" value="" name="postkemoNamaPerawat" />
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="regimen" class="col-form-label col-12 col-md-6 col-lg-2 text-capitalize">Regimen
                            ...
                            <div class="col-12 col-lg-10">
                                ...
                                <div class="row">
                                    <div class="col-12 col-lg-5">
                                        <div class="form-check">
                                            <input class="form-check-input mt-2" type="checkbox" id="check20"
                                                value="Injeksi Dexametasone 5 mg / 1 amp" name="postkemoCheck[]" />
                                            <div class="d-flex flex-row">
                                                <label class="pt-2 col-form-label text-capitalize" for="check20">Injeksi
                                                    Dexametasone 5 mg
                                                    / 1
                                                    amp</label>
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-12 col-lg-5">
                                        <div class="form-check">
                                            <input class="form-check-input mt-2" type="checkbox" id="check21"
                                                value="Injeksi Ranitidine 50 mg / 1 amp" name="postkemoCheck[]" />
                                            <div class="d-flex flex-row">
                                                <label class="pt-2 col-form-label text-capitalize" for="check21">Injeksi
                                                    Ranitidine 50 mg /
                                                    1
                                                    amp</label>
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-12 col-lg-5">
                                        <div class="form-check">
                                            <input class="form-check-input mt-2" type="checkbox" id="check22"
                                                value="Injeksi Ondansentrone 8 mg / 1 amp" name="postkemoCheck[]" />
                                            <div class="d-flex flex-row">
                                                <label class="pt-2 col-form-label text-capitalize" for="check22">Injeksi
                                                    Ondansentrone 8 mg
                                                    /
                                                    1
                                                    amp</label>
                                ...
                                <div class="row">
                                    <div class="col-12 col-lg-5">
                                        <div class="form-check">
                                            <input class="form-check-input mt-2" type="checkbox" id="check23"
                                                value="Injeksi Lasix 20 mg / 1 amp" name="postkemoCheck[]" />
                                            <div class="d-flex flex-row">
                                                <label class="pt-2 col-form-label text-capitalize" for="check23">Injeksi
                                                    Lasix 20 mg / 1
                                                    amp
                                                </label>
                                            </div>
