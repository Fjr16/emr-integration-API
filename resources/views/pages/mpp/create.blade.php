...
@section('content')
    ...
    <div class="card p-3 mt-5 ">
        <form action="{{ route('evaluasi/awal/MPP.store', $item->id) }}" method="POST"
                    ...
                    <div class="col-4">
                        <div class="row">
                            ...
                            <div class="col-6"> <input class="form-control form-control-sm" name="tanggal_masuk"
                                    type="date" value="{{ $ringkasanPasien->tanggal_masuk }}" /></div>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <input class="form-control form-control-sm" name="tanggal_keluar" type="date"
                                    value="{{ $ringkasanPasien->tanggal_keluar ?? '' }}" />
                            </div>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="row">
                            ...
                            <div class="col-6">
                                <input class="form-control form-control-sm" type="text" name="kelas_rawatan"
                                    value="{{ $item->bed->bedroomType->name ?? '' }}" />
                            </div>
                        </div>
                    </div>
                    <div class="col-4">
                ...
                <table class="table table-bordered mt-3">
                    <tr class="text-center">
                        ...
                        <td><input class="form-control form-control-sm" name="tanggal_masuk" type="datetime-local"
                                value="{{ \Carbon\Carbon::parse($ringkasanPasien->tanggal_masuk)->format('Y-m-d') }}T00:00" />
                        </td>
...
@endforeach
                                ...
                                <div class="col-6">
                                    <div class="form-check form-check-inline mt-3 ">
                                        <input class="form-check-input" name="fisik_kognitif" value="Ada gangguan fisik"
                                            type="radio" id="ada_gangguan_fisik" />
                                ...
                                <div class="col-6">
                                    <div class="form-check form-check-inline mt-3 ">
                                        <input class="form-check-input" name="fisik_kognitif" value="Dibantu sebagian"
                                            type="radio" id="dibantu_sebagian" />
                                ...
                                <div class="col-6">
                                    <div class="form-check form-check-inline mt-3 ">
                                        <input class="form-check-input" name="pemahaman_kesehatan"
                                            value="Paham & tidak patuh" type="radio" id="paham_tidak_patuh" />
                                ...
                                <div class="col-6">
                                    <div class="form-check form-check-inline mt-3 d-flex">
                                        <input class="form-check-input" value="Riwayat" type="radio"
                                            id="radio_riwayat_kes" style="min-width: 20px;" />
                                ...
                                <div class="col-6">
                                    <div class="form-check form-check-inline mt-3 d-flex ">
                                        <input class="form-check-input" value="Ya, jenis" type="radio"
                                            style="max-width: 30px" id="jenis_obat_radio" />
                                ...
                                <div class="col-3">
                                    <div class="form-check form-check-inline mt-3 d-flex">
                                        <input class=" form-check-input" name="perilaku" value="Depresi" type="radio"
                                            id="Depresi" style="min-width: 20px;" />
                                ...
                                <div class="col-7  mt-1">
                                    <div class="form-check form-check-inline  d-flex">
                                        <input class="form-check-input" value="Keyakinan tertentu terhadap makanan/obat"
                                            type="radio" id="keyakinan_obat_radio" style="min-width: 20px;" />
                                ...
                                <div class="col-4">
                                    <div class="form-check form-check-inline mt-3 ">
                                        <input class="form-check-input" name="pekerjaan" type="radio"
                                            id="Tidak_bekerja" value="Tidak bekerja" />
                        ...
                        <td class="p-1">
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="form-check form-check-inline mt-3 ">
                                        <input class="form-check-input" name="kesehatan_mental" type="radio"
                                            id="no_paham_merawat" value="Tidak paham cara merawat" />
                                ...
                                <div class="col-6">
                                    <div class="form-check form-check-inline mt-3 ">
                                        <input class="form-check-input" name="kesehatan_mental" type="radio"
                                            id="Gangguan_mental" value="Gangguan mental" />
                                ...
                                <div class="col-6">
                                    <div class="form-check form-check-inline mt-3 ">
                                        <input class="form-check-input" name="kesehatan_mental" type="radio"
                                            id="Gagal_pengobatan" value="Gagal pengobatan" />
                        ...
                        <td class="p-1">
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="form-check form-check-inline mt-3 ">
                                        <input class="form-check-input" name="adaptasi" type="radio"
                                            id="Mampu_beradaptasi" value="Mampu beradaptasi" />
                                ...
                                <div class="col-12">
                                    <div class="form-check form-check-inline mt-3 ">
                                        <input class="form-check-input" name="adaptasi" type="radio"
                                            id="Tidak_mampu_beradaptasi" value="Tidak mampu beradaptasi" />
                        ...
                        <td class="p-1">
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="form-check form-check-inline mt-3 ">
                                        <input class="form-check-input" name="dukungan_keluarga" type="radio"
                                            id="Dipertanyakan" value="Dipertanyakan" />
                                ...
                                <div class="col-6">
                                    <div class="form-check form-check-inline mt-3 ">
                                        <input class="form-check-input" name="dukungan_keluarga" type="radio"
                                            id="Tidak_ada_dukungan" value="Tidak ada" />
                                ...
                                <div class="col-4">
                                    <div class="form-check form-check-inline mt-3 ">
                                        <input class="form-check-input" name="asuransi" type="radio"
                                            id="ada_tidak_aktif" value="Ada, tidak aktif" />
                        ...
                        <td class="p-1">
                            <div class="row">
                                ...
                                <div class="col-4">
                                    <div class="form-check form-check-inline mt-3 ">
                                        <input class="form-check-input" name="lingkungan" type="radio"
                                            id="tidak_lingkungan" value="Sanitasi Buruk" />
                                ...
                                <div class="col-4">
                                    <div class="form-check form-check-inline mt-3 ">
                                        <input class="form-check-input" name="lingkungan" type="radio"
                                            id="Jauh_faskes" value="Jauh dari faskes" />
                                ...
                                <div class="col-6">
                                    <div class="form-check form-check-inline mt-3 ">
                                        <input class="form-check-input" name="perencanaan_lanjutan" type="radio"
                                            id="Discharge_Planning" value="Discharge Planning" />
                                ...
                                <div class="col-9">
                                    <div class="form-check form-check-inline mt-3 d-flex align-items-center">
                                        <input class="form-check-input" type="radio" id="trauma_radio"
                                            value="iya,jenis" style="max-width: 30px ; aspect-ratio:1/1" />
                                ...
                                <div class="col-4">
                                    <div class="form-check form-check-inline mt-3 ">
                                        <input class="form-check-input" name="aspek_legal" type="radio"
                                            id="no_aspek_legal" value="Tidak ada" />
                                ...
                                <div class="col-8">
                                    <div class="form-check form-check-inline mt-3 d-flex ">
                                        <input class="form-check-input" type="radio" style="max-width: 30px"
                                            id="aspek_legal_radio" value="ada," />
                ...
                <table class="table table-bordered " style="margin-top: -5mm">
                    <tr>
                        <td>
                            <textarea class="form-control form-control-sm" id="editor" name="ket_manager_plan" rows="3"></textarea>
                        </td>
                    </tr>
                </table>
    ...
    <script type="text/javascript">
        ...
        selectMajors.forEach(function(selectMajor) {
            selectMajor.addEventListener('change', function() {
                ...
                for (var i = 0; i < selectMajors.length; i++) {
                    var skor = parseInt(selectMajors[i].value) || 0;
                    totalMajor += skor;
                }
        ...
        selectMinors.forEach(function(selectMinor) {
            selectMinor.addEventListener('change', function() {
                ...
                for (var j = 0; j < selectMinors.length; j++) {
                    var skor = parseInt(selectMinors[j].value) || 0;
                    totalMinor += skor;
                }
