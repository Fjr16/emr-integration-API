...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <h4 class="m-0">Assesmen Awal Medis Pasien {{ $item->queue->patient->name }} <span><a
                        href="{{ route('assesmen/awal/medis/ranap.create', $item->id) }}"
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item"
                                            href="{{ route('assesmen/awal/medis/ranap.show', $d->id) }}" target="_blank">
                                            <i class="bx bx-printer me-1"></i>
                                            Print
                                        </a>
                                        <a class="dropdown-item"
                                            href="{{ route('assesmen/awal/medis/ranap.edit', $d->id) }}">
                                            <i class="bx bx-edit-alt me-1"></i>
                                            Edit
                                        </a>
                                        <form action="{{ route('assesmen/awal/medis/ranap.destroy', $d->id) }}"
                                            method="POST">
                                            @csrf
                                            @method('DELETE')
