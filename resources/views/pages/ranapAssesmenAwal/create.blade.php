...
@section('content')
    ...
    <form action="{{ route('assesmen/awal/medis/ranap.store', $item->id) }}" method="POST">
        @csrf
        <div class="card">
            ...
            <div class="card-body">
                ...
                @foreach ($arrPemulangan as $index => $pemulangan)
                    <div class="row">
                        <div class="col-8">
                            <input class="form-check-input" type="hidden" value="{{ $pemulangan }}"
                                id="{{ $pemulangan }}" name="pemulangan_name[{{ $index }}]" />
                        ...
                        <div class="col-4 d-flex">
                            <div class="col-2 d-flex">
                                <input class="form-check-input" type="radio" value="1" id="{{ $pemulangan }}1"
                                    name="pemulangan_value[{{ $index }}]" />
                                <label class="form-check-label d-flex mx-2" for="{{ $pemulangan }}1">
                                    Ya
                                </label>
                            </div>
                            <div class="col-4 d-flex">
                                <input class="form-check-input" type="radio" value="0" id="{{ $pemulangan }}2"
                                    name="pemulangan_value[{{ $index }}]" checked />
                                <label class="form-check-label d-flex mx-2" for="{{ $pemulangan }}2">
                                    Tidak
                                </label>
                            </div>
                        </div>
