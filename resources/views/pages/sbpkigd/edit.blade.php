...
@section('content')
    ...
    <form action="{{ route('rajal/sbpk.update', $item->id) }}" method="POST">
        @method('PUT')
        @csrf
        <div class="card mb-4">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-8">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-9">
                                <input class="form-control" type="date" name="tanggal" value="{{ $item->tanggal ?? '' }}"
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-9">
                                <input class="form-control" type="time" name="jam_keluar"
                                    value="{{ $item->jam_keluar ?? '' }}" id="html5-date-input" />
                            </div>
                        </div>
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-9">
                                <input class="form-control" type="date" name="tanggal_masuk"
                                    value="{{ $item->tanggal_masuk ?? '' }}" id="html5-date-input" />
                            </div>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="mx-3">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="keterangan" value="Kunjungan Awal"
                                    id="defaultRadio1" {{ $item->keterangan == 'Kunjungan Awal' ? 'checked' : '' }} />
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="keterangan" value="Kunjungan Lanjutan"
                                    id="defaultRadio2" {{ $item->keterangan == 'Kunjungan Lanjutan' ? 'checked' : '' }} />
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="keterangan" value="Observasi"
                                    id="defaultRadio3" {{ $item->keterangan == 'Observasi' ? 'checked' : '' }} />
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="keterangan" value="Post Operasi"
                                    id="defaultRadio4" {{ $item->keterangan == 'Post Operasi' ? 'checked' : '' }} />
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-8">
                                    <input class="form-control" type="text" name="berat"
                                        value="{{ $item->berat ?? '' }}" required id="html5-date-input" />
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <table class="table table-bordered mb-3">
                    ...
                    <tbody id="detailSbpk">
                        @foreach ($item->suratBuktiPelayananPatientDetails as $detail)
                            <tr>
                                <td>
                                    <input class="form-control" type="text" name="poliklinik[]"
                                        value="{{ $detail->poliklinik ?? '' }}" />
                                </td>
                                <td>
                                    <input class="form-control" type="text" name="diagnosa[]"
                                        value="{{ $detail->diagnosa ?? '' }}" />
                                </td>
                                <td>
                                ...
                                <td>
                                    <input class="form-control tdt" type="text" name="tdt[]"
                                        value="{{ $item->nama_dokter ?? '' }}" disabled />
                                </td>
                    ...
                    <div class="col-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="konsultasi"
                                value="{{ $item->konsultasi ?? '' }}">
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="mb-3">
                            <label for="editor" class="form-label">USG</label>
                            <input type="text" class="form-control" name="usg" value="{{ $item->usg ?? '' }}">
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="mb-3">
                ...
                <table class="table table-bordered mb-3">
                    ...
                    <tbody id="diagnosaTambahan">
                        <tr>
                            ...
                            <td>
                                <input class="form-control" type="text" name="diagnosis_utama" id="diagnosis_utama"
                                    value="{{ $item->diagnosis_utama ?? '' }}" />
                            </td>
                            <td>
                                <input class="form-control" type="text" name="icdx" id="icdx"
                                    value="{{ $item->icdx ?? '' }}" />
                            </td>
                            <td class="text-center">
                            </td>
                        </tr>
                        @foreach ($item->suratBuktiPelayananSekunderDiagnosis as $sekunder)
                            <tr>
                                <td>
                                    Diagnosis Tambahan
                                </td>
                                <td>
                                    <input class="form-control" type="text" name="diagnosa_name[]"
                                        value="{{ $sekunder->diganosa_name ?? '' }}" />
                                </td>
                                <td>
                                    <input class="form-control" type="text" name="diagnosa_icdx[]"
                                        value="{{ $sekunder->diagnosa_icdx ?? '' }}" />
                                </td>
                                <td class="text-center">
                                    <button type="button" class="btn btn-danger btn-sm"
                                        onclick="removeElement(this)">-</button>
                        ...
                        <tr>
                            <td></td>
                            <td>
                                <input class="form-control" type="text" name="diagnosa_name[]" value="" />
                            </td>
                            <td>
                                <input class="form-control" type="text" name="diagnosa_icdx[]" value="" />
                            </td>
                            <td class="text-center">
                ...
                <table class="table table-bordered mb-3">
                    ...
                    <tbody id="tindakanTambahan">
                        <tr>
                            ...
                            <td>
                                <input class="form-control" type="text" value="{{ $item->tindakan_utama ?? '' }}"
                                    name="tindakan_utama" id="tindakan_utama" />
                            </td>
                            <td>
                                <input class="form-control" type="text" value="{{ $item->icdg ?? '' }}"
                                    name="icdg" id="icdg" />
                            </td>
                            <td class="text-center">
                            </td>
                        </tr>
                        @foreach ($item->suratBuktiPelayananSekunderActions as $action)
                            <tr>
                                <td>
                                    Tindakan Tambahan
                                </td>
                        ...
                        <tr>
                            <td></td>
                            <td>
                                <input class="form-control" type="text" name="action_name[]" value="" />
                            </td>
                            <td>
                                <input class="form-control" type="text" name="action_icdg[]" value="" />
                            </td>
                            <td class="text-center">
                    ...
                    <div class="row">
                        <div class="col-6 text-center">
                            <input type="text" class="form-control" name="nama_dokter" id="nama_dokter"
                                placeholder="Nama Dietisien" readonly>
                        </div>
                    </div>
                </div> --}}
                <div class="mb-3">
                    <div class="text-end">
                        ...
                        <a href="{{ route('rajal/keterangan-sbpk.edit', $item->suratKeteranganPatients->id) }}"
                            class="btn btn-sm btn-primary">Edit Surat Keterangan</a>
    ...
    <script>
        ...
        function tambahDetail() {
            ...
            newTr.innerHTML = `
                ...
                <td>
                  <input class="form-control" type="text" name="tdt[]" value="" id="tdt" />
                </td>
                <td class="text-center">
