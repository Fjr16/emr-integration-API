...
@section('content')
    ...
    <form action="{{ route('rajal/keterangan-sbpk.store', ['id' => $item->id, 'surat_id' => $data->id]) }}" method="POST">
        @csrf
        <div class="card mb-4">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-9">
                                <input class="form-control" type="text"
                                    value="{{ implode('-', str_split(str_pad($data->patient->no_rm ?? '', 6, '0', STR_PAD_LEFT), 2)) }}"
                                    id="no_rm" disabled />
                            </div>
                        </div>
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-9">
                                <input class="form-control" type="text" name="diagnosa" value=""
                                    id="html5-date-input" placeholder="Diagnosa" />
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label for="html5-date-input" class="col-md-3 col-form-label">Terapi</label>
                            <div class="col-md-9">
                                <input class="form-control" type="text" name="terapi" value=""
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-9">
                                <input class="form-control" type="date" name="tgl_surat_rujukan"
                                    value="{{ date('Y-m-d') }}" id="html5-date-input" required />
                            </div>
                        </div>
                    </div>
                    <div class="col-12">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="mb-2">
                                ...
                                <input class="form-control" type="date" name="tgl_kunjungan"
                                    placeholder="Masukkan alasan lain" value="{{ date('Y-m-d') }}" required>
                            </div>
                        </div>
                    </div>
                </div>
