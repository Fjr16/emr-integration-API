...
@section('content')
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('kemoterapi/general/consent.store', $item->id) }}">
                @csrf
                <div class="row">
                    <div class="col-md-6">
                        <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-7">
                                <select class="form-control select2" name="hubungan" onchange="hubunganSelect(this)"
                                    @required(true)>
                ...
                <div class="">
                    ...
                    <p class="">
                        Saya menyetujui untuk perawatan di RSK Bedah Ropanasuri sebagai pasien rawat jalan tergantung kepada
                        rencana asuhan sesuai dengan kebutuhan pasien.
                    </p>
                    <p>
                        ...
                        pengobatan medis seperti yang diperlukan dalam profesional mereka. Prosedur diagnostik dan perawatan
                        medis termasuk terapi tidak terbatas pada electrocardiogram, x-ray (radiologi), tes darah, terapi
                        fisik, pemberian obat (kecuali yang membutuhkan persetujuan khusus / tertulis), perawatan rutin dan
                        prosedur seperti pemasangan infus. pemasangan kateter, spalak, pemberian oksigen, dan suntikan.
                    </p>
                    <p>
                        Saya sadar bahwa praktik kedokteran bukanlah ilmu pasti dan saya mengakui bahwa tidak ada jaminan
                        atas hasil apapun, terhadap perawatan prosedur atau pemeriksaan apapun yang dilakukan kepada saya.
                    </p>
                    <p>
                        Persetujuan yang saya berikan tidak termasuk prosedur pembedahan atau tindakan invasif, anestesi,
                        sedasi, penggunaan darah dan produk darah, perataan atau tindakan berisiko tinggi maka diperlukan
                    ...
                    <div class="">
                        ...
                        <p class="mx-2">
                            ...
                            pertanyaan tentang pengobatan yang diusulkan (termasuk identitas setiap orang yang memberikan
                            atau mengamati pengobatan) setiap saat.
                        </p>
                        <p class="mx-2">
                            Saya mengerti dan memahami bahwa saya memiliki hak untuk menyetujui atau menolak persetujuan,
                            untuk setiap prosedur / terapi dan saya memahami dan menyadari bahwa RSK Bedah Ropanasuri atau
                ...
                <div class="">
                    ...
                    <p>
                        Saya telah mendapat informasi tentang "Hak dan Tanggung jawab Pasien di RSK Bedah Ropanasuri Padang
                        melalui banner, leaflet, dan form tertulis yang disediakan oleh petugas.
                    </p>
                </div>
                <div class="">
                    <h6 class="text-center bg-dark text-white py-2">
                ...
                <div class="">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="radio" id="radioHarta1" name="harta_benda"
                        ...
                        <label class="form-check-label" for="radioHarta1">
                            ...
                            mengambil keputusan untuk menjaga keamanan harta benda mereka karena tidak sadarkan diri atau
                            tidak didampingi penunggu. Dan apabila saya membutuhkan, maka saya dapat menitipkan
                            barang-barang saya kepada Rumah Sakit.
                        </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="radio" id="radioHarta2" name="harta_benda"
                            value="Saya secara pribadi bertanggung jawab atas barang-barang berharga yang saya miliki namun tidak terbatas pada uang, perhiasan, buku, kartu ATM, kartu kredit, handphone atau barang lainnya. Dan apabila saya membutuhkan maka saya dapat menitipkan barang-barang saya kepada Rumah Sakit">
                ...
                <div class="">
                    ...
                    <p>
                        ...
                        hasil tes diagnostik yang akan digunakan untuk perawatan medis, RSK Bedah Ropanasuri akan menjamin
                        kerahasiaannya.
                    </p>
                    <p>
                        ...
                        BPJS Kesehatan, BPJS Ketenagakerjaan, asuransi kesehatan lainnya, Perusahaan, Dinas Kesehatan, atau
                        ...
                        <p class="d-flex">
                            ...
                            <span class="mx-2 col-1">
                                <select class="form-control form-control-sm" name="persetujuan_pelepasan_informasi">
                                    <option value="ya"
                                        {{ $item->persetujuan_pelepasan_informasi == 'ya' ? 'selected' : '' }}>menyetujui
                                    </option>
                                    <option value="tidak"
                            ...
                            pelepasan informasi (diagnosis, hasil pelayanan, dan pengobatan) terkait perawatan saya kepada
