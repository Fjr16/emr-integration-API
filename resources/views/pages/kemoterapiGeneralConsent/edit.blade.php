...
@section('content')
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('kemoterapi/general/consent.update', $item->id) }}">
                @csrf
                @method('PUT')
                ...
                <div class="">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="radio" id="radioHarta1" name="harta_benda"
                            value="{{ $harta1 }}" {{ $item->harta_benda == $harta1 ? 'checked' : '' }}>
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="radio" id="radioHarta2" name="harta_benda"
                            value="{{ $harta2 }}" {{ $item->harta_benda == $harta2 ? 'checked' : '' }}>
