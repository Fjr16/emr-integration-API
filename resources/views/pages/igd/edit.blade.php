    <form action="{{ route('igd/patient.store') }}" method="POST">
    @csrf
    <div class="modal-content">
      <div class="modal-header bg-warning">
        <h5 class="modal-title text-white" id="backDropModalTitle">Anda Menambahkan Pasien IGD: </h5>
      ...
      <div class="modal-body">
        ...
        <div class="row mb-3">
          ...
          <div class="col-sm-9">
            <input type="text" value="{{ $data->tgl ?? '' }}" class="form-control form-control-sm" name="tgl" readonly /> 
          </div>
        </div>
        <div class="row mb-3">
