...
@section('content')
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('igd/general/consent.update', $item->id) }}">
                @csrf
                @method('PUT')
                      ...
                      <p class="d-flex">
                        ...
                        <span class="col-2 mx-2">
                            <select class="form-control form-control-sm" name="kebutuhan_privasi2" @required(true)>
                                <option value="menginginkan" {{ $item->kebutuhan_privasi2 == 'menginginkan' ? 'selected' : '' }}>menginginkan</option>
                                <option value="tidak menginginkan" {{ $item->kebutuhan_privasi2 == 'tidak menginginkan' ? 'selected' : '' }}>tidak menginginkan</option>
                            </select>
                        </span>
