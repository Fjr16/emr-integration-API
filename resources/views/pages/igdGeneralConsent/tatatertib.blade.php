        ...
        <div class="header">
            <div class="row">
                ...
                <div class="col-8 d-flex align-self-center">
                    <h1 class="mx-auto">TATA TERTIB RUMAH SAKIT</h1>
                </div>
                <div class="col-2">
                    <!-- <div
                    ...
                    <tr>
                        <td>
                            <ol class="m-0">
                                ...
                                <li>
                                    Pasien tidak diperkenankan membawa obat-obatan tanpa sepengetahuan dokter / perawat selama 
                                    perawatan.
                                </li>
                                <li>
                        ...
                        <td>
                            ...
                            <div class="row">
                                ...
                                <div class="col-5">
                                    ...
                                    <img class="ms-5 ps-5 border" src="{{ Storage::url($item->ttd) }}" alt="" height="70px">
