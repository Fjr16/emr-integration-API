            ...
            <td>
              ...
              <div class="dropdown">
                ...
                <div class="dropdown-menu">
                  <a class="dropdown-item" href="{{ route('monitoring/cairan/infus.create', $item->rawatInapPatient->id) }}">
                    <i class="bx bx-plus"></i>
                    Tambah
                  </a>
                  <a class="dropdown-item" href="{{ route('monitoring/cairan/infus.edit', $item->rawatInapPatient->id) }}">
                    <i class="bx bx-edit"></i>
                    Edit
                  </a>
                  <a class="dropdown-item" href="{{ route('monitoring/cairan/infus.show', $item->rawatInapPatient->id) }}">
