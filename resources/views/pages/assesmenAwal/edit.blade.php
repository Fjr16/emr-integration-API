...
@section('content')
    ...
    <form action="{{ route('rajal/rmedokter/assesmenawal.update', $data->id) }}" method="POST">
        @csrf
        @method('put')
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="form-check">
                    <input name="isPasien" class="form-check-input" type="radio" value="1" id="pasien"
                        onclick="disabledForm()" {{ $data->isPasien ? 'checked' : '' }} />
                ...
                <div class="form-check">
                    <input name="isPasien" class="form-check-input" type="radio" value="0" id="notPasien"
                        onclick="enableForm()" {{ $data->isPasien ? '' : 'checked' }} />
                    ...
                    <label class="form-check-label d-flex" for="notPasien">
                        ...
                        <span class="mx-2"><input type="text" class="form-control form-control-sm"
                                value="{{ old('name', $data->name ?? '') }}" name="name" id="name"
                                aria-describedby="floatingInputHelp" {{ $data->isPasien ? 'disabled' : '' }} /></span>
                        Hubungan dengan pasien
                        <span class="mx-2"><input type="text" class="form-control form-control-sm"
                                value="{{ old('hubungan', $data->hubungan) }}" name="hubungan" id="hubungan"
                                aria-describedby="floatingInputHelp" {{ $data->isPasien ? 'disabled' : '' }} /></span>
                    </label>
                </div>
                <p class="m-0 fw-bold">Keluhan Utama</p>
                <textarea id="editor5" class="form-control" id="exampleFormControlTextarea1" name="keluhan" rows="2">{!! $data->keluhan ?? '' !!}</textarea>
                ...
                <textarea id="editor1" class="form-control" id="exampleFormControlTextarea1" name="riwayat_penyakit_sekarang"
                    rows="2">{!! $data->riwayat_penyakit_sekarang ?? '' !!}</textarea>
                ...
                <textarea id="editor2" class="form-control" id="exampleFormControlTextarea1" name="riwayat_penyakit_dahulu"
                    rows="2">{!! $data->riwayat_penyakit_dahulu ?? '' !!}</textarea>
                ...
                <textarea id="editor3" class="form-control" id="exampleFormControlTextarea1" name="riwayat_penggunaan_obat"
                    rows="2">{!! $data->riwayat_penggunaan_obat ?? '' !!}</textarea>
                ...
                <textarea id="editor4" class="form-control" id="exampleFormControlTextarea1" name="riwayat_penyakit_keluarga"
                    rows="2">{!! $data->riwayat_penyakit_keluarga ?? '' !!}</textarea>
                ...
                <table class="table">
                    ...
                    <tbody>
                        @foreach ($data->initialAssesmentPhysicalExaminations as $index => $pemeriksaanFisik)
                            <tr id="row">
                                <td>
                ...
                <textarea id="editor6" class="form-control" id="exampleFormControlTextarea1" name="status_lokalis"
                    rows="2">{{ $data->status_lokalis ?? '' }}</textarea>
                <p class="m-0 fw-bold my-4">Hasil Pemeriksaan Penunjang</p>
                @php
                    $labor = '';
                    $radiologi = '';
                    foreach ($data->initialAssesmentSupportingExaminationResults as $penunjang) {
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <textarea class="form-control w-100" rows="2" oninput="concatLabel(this)">{{ $labor ?? '' }}</textarea>
                        <textarea id="value-kolom" class="form-control w-100" name="hasil_pemeriksaan[]" rows="2" hidden>{{ $labor ?? '' }}</textarea>
                    </div>
                </div>
                <div class="row mb-3">
                    <label for="" class="form-label col-sm-2 fw-bold" id="label-kolom">Radiologi</label>
                    <div class="col-sm-10">
                        <textarea class="form-control w-100" rows="2" oninput="concatLabel(this)">{{ $radiologi ?? '' }}</textarea>
                        <textarea id="value-kolom" class="form-control w-100" name="hasil_pemeriksaan[]" rows="2" hidden>{{ $radiologi ?? '' }}</textarea>
                    </div>
                </div>
                @foreach ($data->initialAssesmentSupportingExaminationResults as $penunjang)
                    {{-- @if (Str::startsWith($penunjang->name, 'Labor '))
                        <div class="row mb-3">
                            <label for="" class="form-label col-sm-2 fw-bold" id="label-kolom">Labor</label>
                            <div class="col-sm-10">
                                <textarea class="form-control w-100" rows="2" oninput="concatLabel(this)">{{ $penunjang->name ?? '' }}</textarea>
                    ...
                    @if (!Str::startsWith($penunjang->name, 'Radiologi ') && !Str::startsWith($penunjang->name, 'Labor '))
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <textarea class="form-control w-100" rows="2" name="hasil_pemeriksaan[]">{{ $penunjang->name ?? '' }}</textarea>
                            </div>
                ...
                <textarea id="editor7" class="form-control" id="exampleFormControlTextarea1" name="diagnosa_kerja"
                    rows="2">{{ $data->diagnosa_kerja ?? '' }}</textarea>
                ...
                <textarea id="editor8" class="form-control" id="exampleFormControlTextarea1" name="diagnosa_banding"
                    rows="2">{{ $data->diagnosa_banding ?? '' }}</textarea>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-12">
                        <textarea id="editor" name="terapi" class="form-control">{{ $data->terapi ?? '' }}</textarea>
                    </div>
                </div>
                ...
                @php
                    ...
                    $dirawat = '';
                    $diet = '';
                    foreach ($data->initialAssesmentPlan as $penunjang) {
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <textarea class="form-control" rows="2" oninput="concatLabel(this)">{{ $tindakan ?? '' }}</textarea>
                        <textarea class="form-control" id="value-kolom" name="rencana[]" rows="2" hidden>{{ $tindakan ?? '' }}</textarea>
                    </div>
                </div>
                <div class="row mb-3">
                    <label class="form-label col-sm-2 fw-bold" id="label-kolom">Dirawat di ruang</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control form-control-sm w-100" value="{{ $dirawat ?? '' }}"
                            oninput="concatLabel(this)" />
                        <input type="text" class="form-control form-control-sm w-100" id="value-kolom"
                            name="rencana[]" value="{{ $dirawat ?? '' }}" placeholder="Ruang" aria-describedby="floatingInputHelp"
                            hidden />
                    </div>
                </div>
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control form-control-sm w-100" value="{{ $diet ?? '' }}"
                            oninput="concatLabel(this)" />
                        <input type="text" class="form-control form-control-sm w-100" id="value-kolom"
                            name="rencana[]" value="" placeholder="Diet" aria-describedby="floatingInputHelp"  value="{{ $diet ?? '' }}"
                            hidden />
                    </div>
                </div>
                @foreach ($data->initialAssesmentPlan as $plan)
                    {{-- @if (Str::startsWith($plan->name, 'Tindakan '))
                        <div class="row mb-3">
                            <label class="form-label col-sm-2 fw-bold" id="label-kolom">Tindakan</label>
                            <div class="col-sm-10">
                                <textarea class="form-control" rows="2" oninput="concatLabel(this)">{{ $plan->name ?? '' }}</textarea>
                                <textarea class="form-control" id="value-kolom" name="rencana[]" rows="2" hidden></textarea>
                            </div>
                        </div>
                    @endif
                    @if (Str::startsWith($plan->name, 'Dirawat '))
                        <div class="row mb-3">
                            <label class="form-label col-sm-2 fw-bold" id="label-kolom">Dirawat di ruang</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control form-control-sm w-100"
                                    value="{{ $plan->name ?? '' }}" oninput="concatLabel(this)" />
                                <input type="text" class="form-control form-control-sm w-100" id="value-kolom"
                                    name="rencana[]" value="" placeholder="Ruang"
                                    aria-describedby="floatingInputHelp" hidden />
                            </div>
                        </div>
                    @endif
                    @if (Str::startsWith($plan->name, 'Diet '))
                        <div class="row mb-3">
                            <label class="form-label col-sm-2 fw-bold" id="label-kolom">Diet</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control form-control-sm w-100"
                                    value="{{ $plan->name ?? '' }}" oninput="concatLabel(this)" />
                                <input type="text" class="form-control form-control-sm w-100" id="value-kolom"
                                    name="rencana[]" value="" placeholder="Diet"
                                    aria-describedby="floatingInputHelp" hidden />
                            </div>
                        </div>
                    @endif --}}
                    @if (
                        ...
                        <div class="row mb-3" id="tambah">
                            <div class="col-sm-2"></div>
                            <div class="col-sm-9">
                                <textarea class="form-control" cols="50" rows="2" name="rencana[]">{{ $plan->name ?? '' }}</textarea>
                            </div>
                            <div class="col-1 d-flex align-self-center">
                                <button type="button" class="btn btn-danger btn-sm"
                                    onclick="hapusInput(this)">-</button>
                ...
                @php
                    $arrValEdukasi = $data->initialAssesmentEducationalNeeds->pluck('name')->toArray();
                @endphp
                ...
                @endforeach
                @foreach ($data->initialAssesmentEducationalNeeds as $valEdukasi)
            ...
            <div class="mb-3 mt-2 mx-3 parent row d-flex justify-content-between">
                ...
                <div class="col-md-5 row d-flex justify-content-center">
                    ...
                    <div class="text-center">
                        ...
                        <textarea id="ttd" name="ttd" style="display: none;">{{ $ttd_pasien }}</textarea>
                        <input type="text" style="display: none;" value="false" name="change_ttd" id="change_ttd">
                        <div class="col">
                            <div class="row">
                                <div class="col-12">
                                    <button type="button" class="col-12 btn btn-sm btn-dark"
                                ...
                                <div class="col-12 mt-2">
                                    <input type="text" class="form-control form-control-sm text-center"
                                        name="nm_perawat" id="nm_pasien" value="{{ $nm_pasien }}"
                                        placeholder="Nama Lengkap" readonly>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            saveButton.addEventListener("click", function(e) {
                ...
                signaturePad.clear();
                document.getElementById("change_ttd").value = "true";
