    ...
    <div class="card p-3 mt-5 ">
        ...
        <div class="d-flex">
            <h4 class="align-self-center m-0">PEMBERIAN INFORMASI DAN
                PERSETUJUAN TINDAKAN ANESTESI {{$item->queue->patient->name}}
            </h4>
            {{-- <div class="ms-auto">
        ...
        <form action="{{ route('pemberian/informasi/persetujuan/tindakan/anestesi.store', $item->id) }}" method="POST" onsubmit="return confirm('Apakah Anda Yakin Ingin Melanjutkan ?')">
            @csrf
            <div class="card-body">
                    ...
                    <div class="col-8">
                        <div class="col">
                            <div class="form-check form-check-inline mt-3 ">
                                <input class="form-check-input" type="radio" name="name" id="isPasien" value="{{ $item->queue->patient->name }}" onclick="TruePasien()"/>
                            ...
                            <div class="form-check form-check-inline mt-3 ">
                                ...
                                <input type="text" class="form-control form-control-sm" id="input_notPasien" disabled onchange="tfValueNotPasien(this.value)">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="row text-center">
                        <div class="col-6 row">
                            ...
                            <div class="col">
                                <div class="form-check form-check-inline mt-3 ">
                                    <input class="form-check-input" type="radio" id="{{ $jenisAnestesi }}" value="{{ $jenisAnestesi }}" name="jenis_anestesi" onclick="disableInput()" {{ $loop->first ? 'checked' : '' }}/>
                    ...
                    <div class="row w-100 mt-4">
                        ...
                        <span class="col">
                            <input class=" m-0 form-control form-control-sm " type="text" value="{{ $item->queue->patient->name }}" disabled/>
                        </span>
                        <p class="col">umur,</p>
                        <span class="col">
                ...
                <div class="row">
                    <div class="d-flex col-3">
                        <input class=" m-0 form-control form-control-sm " type="text" value="{{ $item->queue->patient->jenis_kelamin }}" disabled/>
                    </div>
                    <span class="col-1">alamat,</span>
                    <div class="col-8 ">
                        <input type="text" class="form-control form-control-sm" value="{{ $item->queue->patient->alamat }}" disabled>
                    </div>
                </div>
