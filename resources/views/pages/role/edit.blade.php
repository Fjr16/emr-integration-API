...
<div class="card mb-4 mt-5">
  <div class="card-header d-flex align-items-center justify-content-between">
      <h5 class="mb-0">Edit Role</span></h5>
  </div>
  <form method="POST" action="{{ route('user/role.update', $item->id) }}" class="mb-5">
    @method('PUT')
    @csrf
    <div class="card-body">
        <div class="row mb-3">
            ...
            <div class="col-sm-10">
                <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" id="basic-default-name" value="{{ $item->name }}" required />
            </div>
        </div>
    </div>
    <div class="card-header d-flex align-items-center justify-content-between">
      ...
      <div class="row mb-3">
        <div class="col-sm-4 mb-3">
          ...
          @foreach ($formLuarMaps as $formLuarMap)
            <input type="checkbox" id="checkbox[{{ $formLuarMap['id'] }}]" name="permission_id[]" value="{{ $formLuarMap['id'] }}" @if ($item->permissions ?? '') {{ in_array($formLuarMap['id'], $item->permissions->pluck('id')->toArray()) ? 'checked' : '' }} @endif>
        ...
        <div class="col-sm-4 mb-3">
          ...
          @foreach ($transaksiGudangs as $transaksiGudang)
            <input type="checkbox" id="checkbox[{{ $transaksiGudang['id'] }}]" name="permission_id[]" value="{{ $transaksiGudang['id'] }}" @if ($item->permissions ?? '') {{ in_array($transaksiGudang['id'], $item->permissions->pluck('id')->toArray()) ? 'checked' : '' }} @endif>
        ...
        <div class="col-sm-4 mb-3">
          ...
          @foreach ($stokObats as $stokObat)
            <input type="checkbox" id="checkbox[{{ $stokObat['id'] }}]" name="permission_id[]" value="{{ $stokObat['id'] }}" @if ($item->permissions ?? '') {{ in_array($stokObat['id'], $item->permissions->pluck('id')->toArray()) ? 'checked' : '' }} @endif>
        ...
        <div class="col-sm-4 mb-3">
          ...
          @foreach ($distribusis as $distribusi)
            <input type="checkbox" id="checkbox[{{ $distribusi['id'] }}]" name="permission_id[]" value="{{ $distribusi['id'] }}" @if ($item->permissions ?? '') {{ in_array($distribusi['id'], $item->permissions->pluck('id')->toArray()) ? 'checked' : '' }} @endif>
        ...
        <div class="col-sm-4 mb-3">
          ...
          @foreach ($polis as $poli)
            <input type="checkbox" id="checkbox[{{ $poli['id'] }}]" name="permission_id[]" value="{{ $poli['id'] }}" @if ($item->permissions ?? '') {{ in_array($poli['id'], $item->permissions->pluck('id')->toArray()) ? 'checked' : '' }} @endif>
        ...
        <div class="col-sm-4 mb-3">
          ...
          @foreach ($assesmenAwal as $assesmen)
            <input type="checkbox" id="checkbox[{{ $assesmen['id'] }}]" name="permission_id[]" value="{{ $assesmen['id'] }}" @if ($item->permissions ?? '') {{ in_array($assesmen['id'], $item->permissions->pluck('id')->toArray()) ? 'checked' : '' }} @endif>
        ...
        <div class="col-sm-4 mb-3">
          ...
          @foreach ($radiologiReqs as $radiologiReq)
            <input type="checkbox" id="checkbox[{{ $radiologiReq['id'] }}]" name="permission_id[]" value="{{ $radiologiReq['id'] }}" @if ($item->permissions ?? '') {{ in_array($radiologiReq['id'], $item->permissions->pluck('id')->toArray()) ? 'checked' : '' }} @endif>
        ...
        <div class="col-sm-4 mb-3">
          ...
          @foreach ($laborReqs as $laborReq)
            <input type="checkbox" id="checkbox[{{ $laborReq['id'] }}]" name="permission_id[]" value="{{ $laborReq['id'] }}" @if ($item->permissions ?? '') {{ in_array($laborReq['id'], $item->permissions->pluck('id')->toArray()) ? 'checked' : '' }} @endif>
        ...
        <div class="col-sm-4 mb-3">
          ...
          @foreach ($laborPaReqs as $laborPaReq)
            <input type="checkbox" id="checkbox[{{ $laborPaReq['id'] }}]" name="permission_id[]" value="{{ $laborPaReq['id'] }}" @if ($item->permissions ?? '') {{ in_array($laborPaReq['id'], $item->permissions->pluck('id')->toArray()) ? 'checked' : '' }} @endif>
        ...
        <div class="col-sm-4 mb-3">
          ...
          @foreach ($rmePerawats as $rmePerawat)
            <input type="checkbox" id="checkbox[{{ $rmePerawat['id'] }}]" name="permission_id[]" value="{{ $rmePerawat['id'] }}" @if ($item->permissions ?? '') {{ in_array($rmePerawat['id'], $item->permissions->pluck('id')->toArray()) ? 'checked' : '' }} @endif>
        ...
        <div class="col-sm-4 mb-3">
          ...
          @foreach ($asuhans as $asuhan)
            <input type="checkbox" id="checkbox[{{ $asuhan['id'] }}]" name="permission_id[]" value="{{ $asuhan['id'] }}" @if ($item->permissions ?? '') {{ in_array($asuhan['id'], $item->permissions->pluck('id')->toArray()) ? 'checked' : '' }} @endif>
        ...
        <div class="col-sm-4 mb-3">
          ...
          @foreach ($cppts as $cppt)
            <input type="checkbox" id="checkbox[{{ $cppt['id'] }}]" name="permission_id[]" value="{{ $cppt['id'] }}" @if ($item->permissions ?? '') {{ in_array($cppt['id'], $item->permissions->pluck('id')->toArray()) ? 'checked' : '' }} @endif>
        ...
        <div class="col-sm-4 mb-3">
          ...
          @foreach ($prmrjs as $prmrj)
            <input type="checkbox" id="checkbox[{{ $prmrj['id'] }}]" name="permission_id[]" value="{{ $prmrj['id'] }}" @if ($item->permissions ?? '') {{ in_array($prmrj['id'], $item->permissions->pluck('id')->toArray()) ? 'checked' : '' }} @endif>
        ...
        <div class="col-sm-4 mb-3">
          ...
          @foreach ($tindakans as $tindakan)
            <input type="checkbox" id="checkbox[{{ $tindakan['id'] }}]" name="permission_id[]" value="{{ $tindakan['id'] }}" @if ($item->permissions ?? '') {{ in_array($tindakan['id'], $item->permissions->pluck('id')->toArray()) ? 'checked' : '' }} @endif>
        ...
        <div class="col-sm-4 mb-3">
          ...
          @foreach ($receiptDokters as $receipt)
            <input type="checkbox" id="checkbox[{{ $receipt['id'] }}]" name="permission_id[]" value="{{ $receipt['id'] }}" @if ($item->permissions ?? '') {{ in_array($receipt['id'], $item->permissions->pluck('id')->toArray()) ? 'checked' : '' }} @endif>
        ...
        <div class="col-sm-4 mb-3">
          ...
          @foreach ($suratRanaps as $suratRanap)
            <input type="checkbox" id="checkbox[{{ $suratRanap['id'] }}]" name="permission_id[]" value="{{ $suratRanap['id'] }}" @if ($item->permissions ?? '') {{ in_array($suratRanap['id'], $item->permissions->pluck('id')->toArray()) ? 'checked' : '' }} @endif>
        ...
        <div class="col-sm-4 mb-3">
          ...
          @foreach ($ranaps as $ranap)
            <input type="checkbox" id="checkbox[{{ $ranap['id'] }}]" name="permission_id[]" value="{{ $ranap['id'] }}" @if ($item->permissions ?? '') {{ in_array($ranap['id'], $item->permissions->pluck('id')->toArray()) ? 'checked' : '' }} @endif>
        ...
        <div class="col-sm-4 mb-3">
          ...
          @foreach ($skriningRanaps as $skriningRanap)
            <input type="checkbox" id="checkbox[{{ $skriningRanap['id'] }}]" name="permission_id[]" value="{{ $skriningRanap['id'] }}" @if ($item->permissions ?? '') {{ in_array($skriningRanap['id'], $item->permissions->pluck('id')->toArray()) ? 'checked' : '' }} @endif>
        ...
        <div class="col-sm-4 mb-3">
          ...
          @foreach ($cpaRanaps as $cpaRanap)
            <input type="checkbox" id="checkbox[{{ $cpaRanap['id'] }}]" name="permission_id[]" value="{{ $cpaRanap['id'] }}" @if ($item->permissions ?? '') {{ in_array($cpaRanap['id'], $item->permissions->pluck('id')->toArray()) ? 'checked' : '' }} @endif>
        ...
        <div class="col-sm-4 mb-3">
          ...
          @foreach ($tilikRanaps as $tilikRanap)
            <input type="checkbox" id="checkbox[{{ $tilikRanap['id'] }}]" name="permission_id[]" value="{{ $tilikRanap['id'] }}" @if ($item->permissions ?? '') {{ in_array($tilikRanap['id'], $item->permissions->pluck('id')->toArray()) ? 'checked' : '' }} @endif>
        ...
        <div class="col-sm-4 mb-3">
          ...
          @foreach ($assKepRanaps as $assKepRanap)
            <input type="checkbox" id="checkbox[{{ $assKepRanap['id'] }}]" name="permission_id[]" value="{{ $assKepRanap['id'] }}" @if ($item->permissions ?? '') {{ in_array($assKepRanap['id'], $item->permissions->pluck('id')->toArray()) ? 'checked' : '' }} @endif>
        ...
        <div class="col-sm-4 mb-3">
          ...
          @foreach ($rekamMedis as $rm)
            <input type="checkbox" id="checkbox[{{ $rm['id'] }}]" name="permission_id[]" value="{{ $rm['id'] }}" @if ($item->permissions ?? '') {{ in_array($rm['id'], $item->permissions->pluck('id')->toArray()) ? 'checked' : '' }} @endif>
        ...
        <div class="col-sm-4 mb-3">
          ...
          @foreach ($queues as $que)
            <input type="checkbox" id="checkbox[{{ $que['id'] }}]" name="permission_id[]" value="{{ $que['id'] }}" @if ($item->permissions ?? '') {{ in_array($que['id'], $item->permissions->pluck('id')->toArray()) ? 'checked' : '' }} @endif>
        ...
        <div class="col-sm-4 mb-3">
          ...
          @foreach ($pasiens as $pasien)
            <input type="checkbox" id="checkbox[{{ $pasien['id'] }}]" name="permission_id[]" value="{{ $pasien['id'] }}" @if ($item->permissions ?? '') {{ in_array($pasien['id'], $item->permissions->pluck('id')->toArray()) ? 'checked' : '' }} @endif>
        ...
        <div class="col-sm-4 mb-3">
          ...
          @foreach ($farmasiRajals as $farmasiRajal)
            <input type="checkbox" id="checkbox[{{ $farmasiRajal['id'] }}]" name="permission_id[]" value="{{ $farmasiRajal['id'] }}" @if ($item->permissions ?? '') {{ in_array($farmasiRajal['id'], $item->permissions->pluck('id')->toArray()) ? 'checked' : '' }} @endif>
        ...
        <div class="col-sm-4 mb-3">
          ...
          @foreach ($medicineReceipts as $resep)
            <input type="checkbox" id="checkbox[{{ $resep['id'] }}]" name="permission_id[]" value="{{ $resep['id'] }}" @if ($item->permissions ?? '') {{ in_array($resep['id'], $item->permissions->pluck('id')->toArray()) ? 'checked' : '' }} @endif>
        ...
        <div class="col-sm-4 mb-3">
          ...
          @foreach ($kasirs as $kasir)
            <input type="checkbox" id="checkbox[{{ $kasir['id'] }}]" name="permission_id[]" value="{{ $kasir['id'] }}" @if ($item->permissions ?? '') {{ in_array($kasir['id'], $item->permissions->pluck('id')->toArray()) ? 'checked' : '' }} @endif>
        ...
        <div class="col-sm-4 mb-3">
          ...
          @foreach ($radiologis as $radiologi)
            <input type="checkbox" id="checkbox[{{ $radiologi['id'] }}]" name="permission_id[]" value="{{ $radiologi['id'] }}" @if ($item->permissions ?? '') {{ in_array($radiologi['id'], $item->permissions->pluck('id')->toArray()) ? 'checked' : '' }} @endif>
        ...
        <div class="col-sm-4 mb-3">
          ...
          @foreach ($laborPks as $laborPk)
            <input type="checkbox" id="checkbox[{{ $laborPk['id'] }}]" name="permission_id[]" value="{{ $laborPk['id'] }}" @if ($item->permissions ?? '') {{ in_array($laborPk['id'], $item->permissions->pluck('id')->toArray()) ? 'checked' : '' }} @endif>
        ...
        <div class="col-sm-4 mb-3">
          ...
          @foreach ($laborPas as $laborPa)
            <input type="checkbox" id="checkbox[{{ $laborPa['id'] }}]" name="permission_id[]" value="{{ $laborPa['id'] }}" @if ($item->permissions ?? '') {{ in_array($laborPa['id'], $item->permissions->pluck('id')->toArray()) ? 'checked' : '' }} @endif>
        ...
        <div class="col-sm-4 mb-3">
          ...
          @foreach ($formRekonsiRanaps as $formRekonsi)
            <input type="checkbox" id="checkbox[{{ $formRekonsi['id'] }}]" name="permission_id[]" value="{{ $formRekonsi['id'] }}" @if ($item->permissions ?? '') {{ in_array($formRekonsi['id'], $item->permissions->pluck('id')->toArray()) ? 'checked' : '' }} @endif>
        ...
        <div class="col-sm-4 mb-3">
          ...
          @foreach ($igds as $igd)
            <input type="checkbox" id="checkbox[{{ $igd['id'] }}]" name="permission_id[]" value="{{ $igd['id'] }}" @if ($item->permissions ?? '') {{ in_array($igd['id'], $item->permissions->pluck('id')->toArray()) ? 'checked' : '' }} @endif>
        ...
        <div class="col-sm-4 mb-3">
          ...
          @foreach ($statusRanjangs as $statusRanjang)
            <input type="checkbox" id="checkbox[{{ $statusRanjang['id'] }}]" name="permission_id[]" value="{{ $statusRanjang['id'] }}" @if ($item->permissions ?? '') {{ in_array($statusRanjang['id'], $item->permissions->pluck('id')->toArray()) ? 'checked' : '' }} @endif>
      ...
      <div class="row mb-2">
        @foreach ($masters as $master)
          <div class="col-sm-4 mb-0">
            <input type="checkbox" id="checkbox[{{ $master['id'] }}]" name="permission_id[]" value="{{ $master['id'] }}" @if ($item->permissions ?? '') {{ in_array($master['id'], $item->permissions->pluck('id')->toArray()) ? 'checked' : '' }} @endif>
