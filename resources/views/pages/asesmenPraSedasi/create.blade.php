...
@section('content')
    ...
    <div class="mb-4 card">
        ...
        <form action="{{ route('assesmen/pra/sedasi.store', $item->id) }}" method="POST"
            ...
            <div class="card-body">
                <div class="mb-4 row align-items-center">
                    <div class="col">
                        <div class="row align-items-center">
                            ...
                            <div class="col-5">
                                <input type="date" name="tanggal_operasi" class="form-control form-control-sm col"
                                    id="tanggalOperasi" />
                            </div>
                        </div>
                    </div>
                                ...
                                <select class="form-control form-control-sm col select2" id="dokterAnestesi"
                                    ...
                                    @foreach ($dokter as $dokters)
                                        <option value="{{ $dokters->name }}"
                                            {{ $dokters->id == Auth::user()->id ? 'selected' : '' }}>{{ $dokters->name }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
                ...
                <div class="mb-5 col align-items-center">
                    ...
                    <div class="mb-3 row">
                        ...
                        <input class="form-control form-control-sm col" name="diagnosis"
                            value="{{ $suratPengantar->primer ?? '' }}" type="text" id="pemeriksaanDiagnosis" />
                    </div>
                    <div class="mb-3 row">
                        ...
                        <input class="form-control form-control-sm col" name="rencana_operasi"
                            id="pemeriksaanRencanaOperasi" type="text" />
                    </div>
                </div>
                <div class="mb-4 row">
                    <div class="col-6">
                        ...
                        <div class="col">
                            <div class="form-check">
                                <div class="row align-items-center">
                                    <input type="text" id="inputAnamnesa" class="form-control form-control-sm col"
                    ...
                    <div class="col-6">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="row align-items-center">
                                        ...
                                        <input name="makan_terakhir" class="form-control form-control-sm col"
                                            type="time" id="makan_terakhir" />
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="row align-items-center">
                                        ...
                                        <input name="minum_terakhir" class="form-control form-control-sm col"
                                            type="time" id="minum_terakhir" />
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="mb-2 col">
                            <div class="row align-items-center">
                                ...
                                <input name="riwayat_alergi" class="form-control form-control-sm col" type="text"
                                    id="riwayat_alergi" style="max-width: 200px;" />
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        @foreach ($dataNormalResults as $normalResult)
                            <div class="col">
                                <div class="mb-3 row align-items-center">
                                    ...
                                    <input name="normal_result[]" class="form-control form-control-sm col" type="text"
                                        value="" id="{{ $normalResult }}" />
                                </div>
                            </div>
                        @endforeach
                    </div>
                ...
                <div class="mb-4 col">
                    ...
                    <textarea class="form-control" name="hasil_pemeriksaan_lain" id="editor" rows="3"></textarea>
                </div>
                    ...
                    <div class="row row-cols-2">
                        <div class="col">
                            ...
                            <div class="row">
                                ...
                                <div class="col-10">
                                    <textarea class="form-control form-control-sm col" name="penyulit" id="editor2" rows="3"></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="col">
                            ...
                            <div class="row">
                                ...
                                <div class="col-10">
                                    <textarea class="form-control form-control-sm" name="antisipasi" id="editor3" rows="3"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="p-3 border rounded">
                        ...
                        <div class="px-3 pb-5 col">
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <textarea class="form-control" id="editor4" rows="3" name="obat_diberhentikan"></textarea>
                                </div>
                            </div>
                                            ...
                                            <div class="col-3">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <input type="number" class="form-control form-control-sm"
                                                        name="detail_persiapan_darah_value[]" style="max-width: 100px;"
                                                        @disabled(true)>
                ...
                <div class="mb-3 col">
                    <p class="m-0">Rencana Pemberian Obat analgesia pasca
                        operasi</p>
                    <textarea class="form-control" name="obat_analgesia" id="editor5" rows="3"></textarea>
                </div>
                ...
                <div class="row mb-5">
                    <div class="col-3 text-center">
                        <input type="text" class="form-control form-control-sm text-center" id="nama_user"
                            name="nama_dpjp_anestesi" placeholder="Nama Lengkap" @readonly(true)>
                    </div>
                </div>
    ...
    <script>
        function evaluasiJalanNafas(element) {
            ...
            newDiv.innerHTML = `    <input name="evaluasiJalanNafas[]" class="form-control form-control-sm" type="text" value="" id="evaluasiJalanNafas_lain"/>
                                <button type="button" class="btn btn-danger btn-sm mx-2" onclick="evaluasiJalanNafasDelete(this)"><i class="bx bx-minus"></i></button>
                            `;
            row.append(newDiv);
        }
