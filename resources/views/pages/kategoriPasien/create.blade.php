...
<div class="card mb-4">
  <div class="card-header d-flex align-items-center justify-content-between">
      <h5 class="mb-0">Tambah Kategori Pasien</h5>
  </div>
  <div class="card-body">
      <form method="POST" action="{{ route('pasien/category.store') }}">
          ...
          <div class="row mb-4">
              ...
              <div class="col-sm-1">
                  <input type="number" oninput="this.value=this.value.slice(0,3)" name="margin" class="form-control" id="basic-default-name" value="0" required />
              </div>
