...
@section('content')
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('ringkasan-masuk-keluar.update', $data->id) }}">
                @csrf
                @method('PUT')
                <div class="row mb-3">
                            ...
                            <table>
                                <tr>
                                    <td><input type="radio" name="pendidikan_terakhir" id="sd" class="mx-2"
                                            value="{{ $data->pendidikan_terakhir }}" checked>{{ $data->pendidikan_terakhir }}</td>
                                </tr>
                            </table>
                                    ...
                                    <tr>
                                        <td>
                                            <input type="radio" name="suku_bangsa" id="Minang" class="mx-2"
                                                value="{{ $data->suku_bangsa }}" checked
                                                required>{{ $data->suku_bangsa }}
                                        </td>
                                    </tr>
                                </table>
                                <div class="col-sm-7">
                                    ...
                                    <tr>
                                        <td>
                                            <input type="radio" name="pekerjaan" id="PNS" class="mx-2"
                                                value="{{ $data->rawatInapPatient->queue->patient->job->name }}" checked
                                                required>{{ $data->rawatInapPatient->queue->patient->job->name }}
                                        </td>
                                    </tr>
                                </table>
                                <div class="col-sm-7">
