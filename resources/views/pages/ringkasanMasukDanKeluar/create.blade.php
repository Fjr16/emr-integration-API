...
@section('content')
    <div class="card mb-4">
        <div class="card-header d-flex align-items-center justify-content-between">
            <h5 class="mb-0">Buat Ringkasan Masuk Dan Keluar</h5>
        </div>
        <div class="card-body">
            <form method="POST" action="{{ route('ringkasan-masuk-keluar.store', $item->id) }}">
                @csrf
                {{-- <div class="row mb-3">
                ...
                <div class="row">
                            ...
                            <div class="row mb-3">
                                ...
                                <div>
                                    <table>
                                        <tr>
                                            <td>
                                                <input type="radio" name="pekerjaan" @required(true) id="PNS"
                                                    checked class="mx-2"
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="row mb-3">
                            ...
                            <div>
                                @hasanyrole('Perawat Ranap | Admisi Ranap')
                                    <table>
                                        <tr>
                                            <td>
                    ...
                    <div class="row mb-5">
                        ...
                        <div class="col-4 text-center">
                            ...
                            <textarea id="ttdDietisien" name="tandaTangan" style="display: none;"></textarea>
                    ...
                    <div class="row">
                        <div class="col-4 text-center">
                            <input type="text" class="form-control" name="nama_petugas" id="nama_petugas"
                                placeholder="Nama Petugas" @readonly(true)>
                        </div>
                    </div>
...
<script>
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        saveButtonInput.addEventListener("click", function(e) {
            ...
            $.ajax({
                type: 'get',
                url: "{{ route('ringkasan-masuk-keluar.ttd') }}",
                data: {
