...
<div class="card mb-4">
  <div class="card-header d-flex align-items-center justify-content-between">
      <h5 class="mb-0">Edit Ranjang</h5>
  </div>
  <div class="card-body">
      <form method="POST" action="{{ route('kamar/ranjang.update', $item->id) }}" enctype="multipart/form-data">
        @method('PUT')
          @csrf
          <div class="row mb-3">
              ...
              <div class="col-sm-10">
                  <select class="form-select" id="exampleFormControlSelect1"
                      ...
                      @foreach ($types as $type)
                          @if (old('bedroom_type_id', $item->bedroom_type_id) == $type->id)
              ...
              <div class="col-sm-10">
                  <select class="form-select" id="exampleFormControlSelect1"
                      ...
                      @foreach ($bedrooms as $bedroom)
                          @if (old('bedroom_id', $item->bedroom_id) == $bedroom->id)
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-10">
                <input class="form-check-input" type="checkbox" id="isAvailable" name="isAvailable" value="1" {{ (old('isAvailable') || $item->isAvailable == 1) ? 'checked' : '' }}>
            </div>
        </div>
