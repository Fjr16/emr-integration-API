...
<div class="card mb-4">
  <div class="card-header d-flex align-items-center justify-content-between">
      <h5 class="mb-0">Edit Konversi </h5>
  </div>
  <div class="card-body">
      <form method="POST" action="{{ route('farmasi/obat/konversi.update', $item->id) }}">
          @csrf
          @method('PUT')
          <div class="row mb-3">
            ...
            <div class="col-sm-10">
              <select class="form-select select2" id="medicine_id" name="medicine_id" aria-label="Default select example" onchange="getSatuan(this)">
                  ...
                  @foreach ($medicines as $medicine)
                      @if (old('medicine_id', $item->medicine_id) == $medicine->id)
            ...
            <div class="col-sm-10">
              <select class="form-select" name="unit_from" aria-label="Default select example">
                  ...
                  @foreach ($data as $satuan)
                      @if (old('unit_from', $item->unit_from) == $satuan->name)
        ...
        <div class="row mb-3">
            <label class="col-sm-2 col-form-label" for="basic-default-name">Ke Satuan</label>
            <div class="col-sm-10">
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-10">
                <input type="number" name="nilai" class="form-control" id="basic-default-name" value="{{ old('nilai', $item->nilai) }}" required />
            </div>
        </div>
