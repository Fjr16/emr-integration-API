...
class PatientTest extends TestCase
{
    public function test_patient_valid_data()
    {
        ...
        $response = $this->post('/pasien/store', [
            ...
            'agama' => $faker->randomElement(['Islam', 'Budha', 'Kristen Protestan', 'Kristen Katolik', 
                                                'Hindu', 'Konghucu', 'dll']),
            'alamat' => fake()->address(),
            'rw' => '00',
            'rt' => '00',
            'pendidikan' => $faker->randomElement(['TIDAK SEKOLAH', 'PAUD', 
                                                    'TK','SD', 'SMP / MTS / SLTP SEDERAJAT', 
                                                    'SMA / SMK / SLTA SEDERAJAT', 'S1', 'S2', 'S3']),
    ...
    public function test_patient_invalid_data()
    {
        $response = $this->post('/pasien/store', [
            ...
            'agama' => fake()->randomElement(['Islam', 'Budha', 'Kristen Protestan', 
                                            'Kristen Katolik', 'Hindu', 'Konghucu', 'dll']),
            'alamat' => fake()->address(),
            'rw' => '00',
            'rt' => '00',
            'pendidikan' => fake()->randomElement(['TIDAK SEKOLAH', 'PAUD', 'TK','SD', 
                                                    'SMP / MTS / SLTP SEDERAJAT', 
                                                    'SMA / SMK / SLTA SEDERAJAT', 'S1', 'S2', 'S3']),
