...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('rekap_tindakan_pelayanan_patient_details', function (Blueprint $table) {
            $table->id();
            $table->foreignId('ranap_rekap_tindakan_pelayanan_patient_id')->nullable();
    ...
    {
        Schema::dropIfExists('rekap_tindakan_pelayanan_patient_details');
    }
};
