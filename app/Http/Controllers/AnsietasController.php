...
class AnsietasController extends Controller
{
    /**
    ...
    {
        return view('pages.ansietas.index', [
            'title' => 'Ansietas',
            'menu' => 'In Patient'
        ]);
    }
    ...
    public function store(Request $request)
    {
        ...
        $nafas = 'frekuensi nafas ' . $request->input('nafas') . ' x/l';
        $nadi = 'frekuensi nadi ' . $request->input('nadi') . ' x/l';
        $darah = 'tekanan darah ' . $request->input('darah') . ' mmHg';

        $data = [$majorSubjektif, $majorObjektif, $minorSubjektif, $minorObjektif, $dkbd, $dkdd, $luaran, $observasi, $terapeutik, $edukasi, $implementasi, $evaluasi, $jam, $nafas, $nadi, $darah];
        dd($data);
    }
